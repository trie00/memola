  ...
  return (
    ...
    '<main id="memola-main">' +
      ...
      '<div id="memola-tabbar">' +
        ...
        '<button id="memola-help-btn" class="memola-tabbar-act" title="使い方ヘルプ">' + ICONS.info + '</button>' +
      ...
      '<div id="memola-tb">' +
        ...
        '<button class="memola-b" data-cmd="comment" title="コメント">💬</button>' +
        '<span class="memola-bs"></span>' +
    ...
    '<div id="memola-col-md"><div class="memola-mb" style="max-width:380px">' +
      ...
      '<div class="memola-col-row"><label>タイプ</label>' +
        '<div id="memola-col-type-grid">' +
          ...
          '<div class="memola-col-type" data-tk="relation" data-ic="🔗"><span class="memola-col-type-ic">🔗</span><span>リレーション(他DB)</span></div>' +
    ...
    '<div id="memola-ftb">' +
      ...
      '<button class="memola-fb" data-cmd="comment" title="コメント">💬</button>' +
      ...
      '<div class="memola-set-body">' +
        ...
        '<div class="memola-set-panes">' +
          ...
          '<div class="memola-set-pane" data-pane="dev">' +
            ...
            '</div>' +
            '<div class="memola-set-row"><label>relay 配信フォルダ</label>' +
              '<input id="memola-set-dev-relaydir" type="text" placeholder="例: C:\\\\tools\\\\n365\\\\dist (relay が memola.bundle.js を配る場所)">' +
              '<div class="memola-set-hint" id="memola-set-dev-relaydir-status">relay に照会します…</div>' +
            '</div>' +
