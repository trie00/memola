...
// fine for the document sizes Memola handles (typically ≪ 10k lines).
 ...
 *  Memola editor produces `<br>`, which `htmlToMd` serialises as a
 ...
 *  document sizes; if Memola ever needs to merge multi-megabyte text
