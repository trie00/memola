...
`)};o.push(b);continue}let s=r.match(/^(#{1,3})\s+(.*)$/);if(s){let v=s[1].length,g=Ss(s[2]),b="h"+v,x={id:ee(),kind:b,inline:g};o.push(x),n++;continue}let l=r.match(/^\s*-\s+\[([ xX])\]\s*(.*)$/);if(l){let v=l[1].toLowerCase()==="x",g={id:ee(),kind:"todo",checked:v,inline:Ss(l[2])};o.push(g),n++;continue}let c=r.match(/^>\s*\[([^\sA-Za-z0-9][^\]]*)\]\s*(.*)$/);if(c){let v=c[1],g=[c[2]];for(n++;n<t.length&&/^>\s?/.test(t[n]);)g.push(t[n].replace(/^>\s?/,"")),n++;let b=Xe(g.join(`
...
`),y={id:ee(),kind:"p",inline:Ss(h)};o.push(y)}return o}function LL(e){return!!(/^#{1,3}\s+/.test(e)||/^```/.test(e)||/^\s*---+\s*$/.test(e)||/^\s*\*\*\*+\s*$/.test(e)||/^\s*-\s+\[[ xX]\]/.test(e)||/^>\s?/.test(e)||/^(\s*)[-*+]\s+/.test(e)||/^(\s*)\d+\.\s+/.test(e))}function Ss(e){return e?(e=e.replace(/  +\n/g,`<br>
...
`&&a++;continue}if(s==="["&&e[a+1]==="["){let l=e.indexOf("]]",a+2);if(l>=0&&l<o){let c=e.substring(a+2,l),m=c.indexOf("|"),p=m<0?c:c.substring(0,m),u=m<0?void 0:c.substring(m+1);i();let f=p.match(/^daily:(\d{4}-\d{2}-\d{2})$/);f?n.push({kind:"dailylink",date:f[1],...u!==void 0?{alias:u}:{}}):n.push({kind:"pagelink",pageId:p,...u!==void 0?{alias:u}:{}}),a=l+2;continue}}if(s==="["){let l=Av(e,"]",a+1,o);if(l>=0&&e[l+1]==="("){let c=Av(e,")",l+2,o);if(c>=0){let m=e.substring(a+1,l),p=e.substring(l+2,c);i(),n.push({kind:"link",href:p,children:Ss(m)}),a=c+1;continue}}}if(s==="`"){let l=e.indexOf("`",a+1);if(l>=0&&l<o){i(),n.push({kind:"code",text:e.substring(a+1,l)}),a=l+1;continue}}if(e.startsWith("~~",a)){let l=e.indexOf("~~",a+2);if(l>=0&&l<o){i(),n.push({kind:"strike",children:Yc(e,a+2,l)}),a=l+2;continue}}if(e.startsWith("**",a)||e.startsWith("__",a)){let l=e.substr(a,2),c=e.indexOf(l,a+2);if(c>=0&&c<o){i(),n.push({kind:"bold",children:Yc(e,a+2,c)}),a=c+2;continue}}if((s==="*"||s==="_")&&e[a+1]!==s){let l=e.indexOf(s,a+1);if(l>=0&&l<o&&e[l-1]!==s){i(),n.push({kind:"italic",children:Yc(e,a+1,l)}),a=l+1;continue}}if(s==="\\"&&a+1<o&&/[!-/:-@[-`{-~]/.test(e[a+1])){r+=e[a+1],a+=2;continue}r+=s,a++}return i(),n}function SL(e){return e.replace(/([\\`*_~[\]])/g,"\\$1")}function Av(e,t,o,n){for(let r=o;r<n;r++){if(e[r]==="\\"){r++;continue}if(e[r]===t)return r}return-1}function Je(e){let t="";for(let o=0;o<e.length;o++){let n=e[o],r=ML(n).replace(/\n+$/,"");if(t){let i=e[o-1].kind==="todo"&&n.kind==="todo";t+=i?`
`:`
...
`}}var Ct=L(()=>{"use strict";rn()});function Bv(e){let t=document.createElement("div");return t.innerHTML=e,qa(t)}function qa(e){let t=[];for(let o of Array.from(e.childNodes)){if(o.nodeType===3){let i=(o.textContent||"").trim();if(i){let s={id:ee(),kind:"p",inline:[{kind:"text",text:i}]};t.push(s)}continue}if(o.nodeType!==1)continue;let n=o,r=n.tagName.toLowerCase();if((r==="div"||r==="section")&&!BL(n)){t.push(...qa(n));continue}let a=DL(n);a&&t.push(a)}return t}function BL(e){let t=e.classList;return t.contains("memola-todo")||t.contains("memola-callout")||t.contains("memola-itbl-wrap")||t.contains("memola-linkdb")||t.contains("memola-ai-block")}function DL(e){let t=e.tagName.toLowerCase();if(t==="img"){let r=e.getAttribute("src")||"",a=e.getAttribute("alt")||"";return{id:ee(),kind:"image",src:r,alt:a}}if(t==="div"&&e.classList.contains("memola-itbl-wrap")){let r=e.querySelector("table.memola-itbl");if(!r)return null;let a=r.dataset.hrow==="1",i=r.dataset.hcol==="1",s=[],l=[];for(let c of Array.from(r.querySelectorAll("tr"))){let m=[];for(let p of Array.from(c.children))m.push(fo(p));l.push(m)}return{id:ee(),kind:"table",hrow:a,hcol:i,rows:l}}if(t==="div"&&e.classList.contains("memola-linkdb")){let r=e.getAttribute("data-db-id")||"",a=e.getAttribute("data-view")||"table",i=e.getAttribute("data-filter")||"",s=e.getAttribute("data-sort")||"";return{id:ee(),kind:"linkdb",dbId:r,view:a,filter:i,sort:s}}if(t==="div"&&e.classList.contains("memola-ai-block")){let r=e.getAttribute("data-aib-action")||"",a=e.getAttribute("data-aib-result")||"";return{id:ee(),kind:"ai",prompt:r,result:a}}if(t==="div"&&e.classList.contains("memola-todo")){let r=e.querySelector(".memola-todo-cb"),a=e.querySelector(".memola-todo-txt");return{id:ee(),kind:"todo",checked:!!(r&&r.checked),inline:a?fo(a):[]}}if(t==="div"&&e.classList.contains("memola-callout")){let r=e.querySelector(".memola-callout-ic"),a=e.querySelector(".memola-callout-body");return{id:ee(),kind:"callout",emoji:(r?.textContent||"\u{1F4A1}").trim(),children:a?qa(a):[]}}if(t==="h1"||t==="h2"||t==="h3")return{id:ee(),kind:t,inline:fo(e)};if(t==="p"){let r=fo(e);return{id:ee(),kind:"p",inline:r}}if(t==="pre"){let r=e.querySelector("code"),a=r?.className.replace(/^language-/,"")||"",i=r?.textContent??e.textContent??"";return{id:ee(),kind:"code",lang:a,text:i}}if(t==="hr")return{id:ee(),kind:"rule"};if(t==="blockquote")return{id:ee(),kind:"quote",children:qa(e)};if(t==="ul"||t==="ol"){let r=[];for(let i of Array.from(e.children)){if(i.tagName.toLowerCase()!=="li")continue;if(Array.from(i.children).some(l=>/^(p|h\d|ul|ol|pre|blockquote|hr|div)$/i.test(l.tagName)))r.push(qa(i));else{let l=fo(i);r.push([{id:ee(),kind:"p",inline:l}])}}return{id:ee(),kind:"list",ordered:t==="ol",items:r}}if(t==="div"||t==="section")return qa(e)[0]||null;let o=fo(e);return o.length===0?null:{id:ee(),kind:"p",inline:o}}function fo(e){let t=[];for(let o of Array.from(e.childNodes)){if(o.nodeType===3){let a=o.textContent||"";a&&t.push({kind:"text",text:a});continue}if(o.nodeType!==1)continue;let n=o,r=n.tagName.toLowerCase();if(r==="br"){t.push({kind:"br"});continue}if(r==="strong"||r==="b"){t.push({kind:"bold",children:fo(n)});continue}if(r==="em"||r==="i"){t.push({kind:"italic",children:fo(n)});continue}if(r==="s"||r==="strike"||r==="del"){t.push({kind:"strike",children:fo(n)});continue}if(r==="code"){t.push({kind:"code",text:n.textContent||""});continue}if(r==="a"){let a=n.getAttribute("data-daily-date");if(a){let s=(n.textContent||"").trim()||void 0;t.push({kind:"dailylink",date:a,...s?{alias:s}:{}});continue}if(n.classList.contains("memola-page-link")){let s=n.getAttribute("data-page-id")||"",l=(n.textContent||"").trim()||void 0;t.push({kind:"pagelink",pageId:s,...l?{alias:l}:{}});continue}let i=n.getAttribute("href")||"";t.push({kind:"link",href:i,children:fo(n)});continue}t.push(...fo(n))}return t}function sn(e){return e.map(_L).join("")}function Ro(e){return sn(Xe(e))}function _L(e){switch(e.kind){case"p":return"<p>"+_o(e.inline)+"</p>";case"h1":return"<h1>"+_o(e.inline)+"</h1>";case"h2":return"<h2>"+_o(e.inline)+"</h2>";case"h3":return"<h3>"+_o(e.inline)+"</h3>";case"todo":return'<div class="memola-todo"><input type="checkbox" class="memola-todo-cb"'+(e.checked?" checked":"")+'><span class="memola-todo-txt">'+_o(e.inline)+"</span></div>";case"rule":return"<hr>";case"code":return"<pre><code"+(e.lang?' class="language-'+e.lang+'"':"")+">"+Lr(e.text)+"</code></pre>";case"quote":return"<blockquote>"+sn(e.children)+"</blockquote>";case"callout":return'<div class="memola-callout"><span class="memola-callout-ic">'+Lr(e.emoji)+'</span><div class="memola-callout-body">'+sn(e.children)+"</div></div>";case"list":{let t=e.ordered?"ol":"ul",o=e.items.map(n=>n.length===1&&n[0].kind==="p"?"<li>"+_o(n[0].inline)+"</li>":"<li>"+sn(n)+"</li>").join("");return"<"+t+">"+o+"</"+t+">"}case"image":return'<img src="'+On(e.src)+'" alt="'+On(e.alt)+'" class="memola-img">';case"email":return'<div class="memola-email-chip" data-imid="'+On(e.imid)+'">\u{1F4E7} '+On(e.subject||"(\u4EF6\u540D\u306A\u3057)")+(e.from?' \u2014 <span class="memola-email-from">'+On(e.from)+"</span>":"")+"</div>";case"table":case"linkdb":case"ai":return"<!-- block-tree:"+e.kind+" id="+e.id+" -->"}}function _o(e){let t="";for(let o of e)t+=RL(o);return t}function RL(e){switch(e.kind){case"text":return Lr(e.text);case"bold":return"<strong>"+_o(e.children)+"</strong>";case"italic":return"<em>"+_o(e.children)+"</em>";case"strike":return"<s>"+_o(e.children)+"</s>";case"code":return"<code>"+Lr(e.text)+"</code>";case"link":return'<a href="'+On(e.href)+'">'+_o(e.children)+"</a>";case"pagelink":{let t=e.alias||e.pageId;return'<a class="memola-page-link" data-page-id="'+On(e.pageId)+'">'+Lr(t)+"</a>"}case"dailylink":{let t=e.alias||e.date;return'<a class="memola-page-link memola-daily-link" data-daily-date="'+On(e.date)+'">'+Lr(t)+"</a>"}case"br":return"<br>"}}function Lr(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function On(e){return Lr(e).replace(/"/g,"&quot;")}var ln=L(()=>{"use strict";rn();Ct()});var _v={};j(_v,{applySiblingOrder:()=>Cs,collectDescendantIds:()=>cn,computeReorder:()=>mu,countDescendants:()=>Ms,saveSiblingOrder:()=>$a});function cn(e,t){let o=[t];return e.filter(n=>n.ParentId===t).forEach(n=>{o.push(...cn(e,n.Id))}),o}function Ms(e,t){return cn(e,t).length-1}function Dv(){return Nc.get()}function NL(e){Nc.set(e)}function Cs(e,t){let n=Dv()[e||""];if(!n||n.length===0)return t;let r=new Map(t.map(i=>[i.Id,i])),a=[];for(let i of n){let s=r.get(i);s&&(a.push(s),r.delete(i))}for(let i of r.values())a.push(i);return a}function $a(e,t){let o=Dv();o[e||""]=t,NL(o)}function mu(e,t,o,n){let r=e.map(s=>s.Id),a=r.indexOf(t);a>=0&&r.splice(a,1);let i=r.indexOf(o);return i<0&&(i=r.length),n||(i+=1),r.splice(i,0,t),r}var Sr=L(()=>{"use strict";be()});async function Ka(e){let t=Pt(e);return t&&(await re(J(nt(e),"/items("+t+")?$select=Editor/Title&$expand=Editor")))?.Editor?.Title||""}function Hn(){return Xc||(Xc=(async()=>(await re(G+"/_api/web/currentuser?$select=Title"))?.Title||"")().catch(()=>""),Xc)}function ut(){return Jc||(Jc=(async()=>(await re(G+"/_api/web/currentuser?$select=Id"))?.Id||0)().catch(()=>0),Jc)}function Va(e){if(!e)return Promise.resolve("");let t=Rv.get(e);if(t!==void 0)return Promise.resolve(t);let o=pu.get(e);if(o)return o;let n=(async()=>{let a=(await re(G+"/_api/web/getuserbyid("+e+")?$select=Title").catch(()=>null))?.Title||"";return Rv.set(e,a),pu.delete(e),a})();return pu.set(e,n),n}var Xc,Jc,Rv,pu,eo=L(()=>{"use strict";V();Fe();St();Xc=null,Jc=null;Rv=new Map,pu=new Map});var Fv={};j(Fv,{getBacklinksFor:()=>Ps,invalidateBacklinkCache:()=>dn,scanBlocks:()=>Hv});function dn(){Zc=null,Mr=null}async function Nv(e){let t=[],o=J(e,"/items?$select=Id,Title,Body_blocks,PageType,OriginPageId,IsTemplate&$top=500&$orderby=Id"),n=0;for(;o&&n++<50;){let r=await re(o);if(!r)break;for(let a of r.results)a._srcList=e,t.push(a);o=r.__next}return t}async function OL(){return Zc||Mr||(Mr=(async()=>{let e=to(),t=[Nv(de)];e!==de&&t.push(Nv(e).catch(()=>[]));let n=(await Promise.all(t)).flat();return Zc=n,Mr=null,n})().catch(e=>{throw Mr=null,e}),Mr)}async function Ps(e,t){if(!e)return[];let o=await OL(),n=[];for(let r of o){let a=Cr(r._srcList||de,r.Id);if(a===e||r.PageType==="draft"||r.OriginPageId||r.PageType==="row"||r.IsTemplate)continue;let i=r.Body_blocks||"";if(!i)continue;let s;try{s=ge(i)}catch{continue}let{count:l,snippet:c}=Hv(s,e);l!==0&&n.push({pageId:a,pageTitle:t?.(a)||r.Title||"\u7121\u984C",snippet:c,count:l})}return n.sort((r,a)=>a.count-r.count||r.pageTitle.localeCompare(a.pageTitle,"ja")),n}function Hv(e,t){let o=0,n="",r=i=>{let s=0;for(let l of i)l.kind==="pagelink"&&l.pageId===t?s++:(l.kind==="bold"||l.kind==="italic"||l.kind==="strike"||l.kind==="link")&&(s+=r(l.children));return s},a=i=>{for(let s of i){if("inline"in s&&Array.isArray(s.inline)){let l=r(s.inline);l>0&&(o+=l,n||(n=Ov(Mt(s.inline))))}if(s.kind==="table")for(let l of s.rows)for(let c of l){let m=r(c);m>0&&(o+=m,n||(n=Ov(Mt(c))))}if((s.kind==="quote"||s.kind==="callout")&&a(s.children),s.kind==="list")for(let l of s.items)a(l)}};return a(e),{count:o,snippet:n}}function Ov(e){let t=e.replace(/\s+/g," ").trim();return t.length>100?t.substring(0,100).trimEnd()+"\u2026":t}var Zc,Mr,As=L(()=>{"use strict";St();V();rn();Zc=null,Mr=null});var Qc={};j(Qc,{addPage:()=>go,metaById:()=>D,removePages:()=>No,setMetaPages:()=>uu,setPageTitle:()=>Wa});function D(e){return e&&d.meta.pages.find(t=>t.id===e)||null}function uu(e){let t=new Set;d.meta.pages=e.filter(o=>t.has(o.id)?!1:t.add(o.id))}function go(e,t={}){d.meta.pages.some(o=>o.id===e.Id)||d.meta.pages.push({id:e.Id,title:e.Title,parent:e.ParentId||"",type:e.Type,...t})}function No(e){let t=new Set(e);t.size!==0&&(d.meta.pages=d.meta.pages.filter(o=>!t.has(o.id)))}function Wa(e,t){let o=d.meta.pages.find(n=>n.id===e);o&&(o.title=t)}var ve=L(()=>{"use strict";q()});var zv={};j(zv,{deleteAllRowEntriesForList:()=>fu,deleteRowEntry:()=>Pr,getRowBody:()=>ho,getRowBodyBlocks:()=>HL,setRowBody:()=>Oo});async function ed(e,t){let o="PageType eq 'row' and ListTitle eq '"+e.replace(/'/g,"''")+"' and DbRowId eq "+t,n=J(de,"/items?$select=Id&$filter="+encodeURIComponent(o)+"&$orderby=Id&$top=20"),r=await re(n);return r?r.results.map(a=>({id:a.Id,etag:a.__metadata?.etag||""})):[]}async function Uv(e,t){return(await ed(e,t))[0]||null}async function ho(e,t){await jt();let o=await Uv(e,t);if(!o)return"";let n=J(de,"/items("+o.id+")?$select=Body_blocks"),r=await re(n);return UL(r?.Body_blocks)}async function HL(e,t){await jt();let o=await Uv(e,t);if(!o)return"";let n=J(de,"/items("+o.id+")?$select=Body_blocks");return(await re(n))?.Body_blocks||""}async function Oo(e,t,o,n,r){await jt();let a=FL(r),i=await ed(e,t);if(i.length>=1){await je(de,i[0].id,{Title:n,Body_blocks:a});for(let m=1;m<i.length;m++)await Ve(de,i[m].id).catch(()=>{});return}let l=(o?D(o):null)?.scope||"user";await Ne(de,{Title:n,ParentId:o||"",PageType:"row",ListTitle:e,DbRowId:t,Body_blocks:a,Scope:l});let c=await ed(e,t);if(c.length>1){await je(de,c[0].id,{Title:n,Body_blocks:a}).catch(()=>{});for(let m=1;m<c.length;m++)await Ve(de,c[m].id).catch(()=>{})}}function FL(e){let t=(e||"").trim();if(!t)return"[]";if(t.startsWith("["))try{let o=JSON.parse(t);if(Array.isArray(o))return t}catch{}return JSON.stringify(Xe(e))}function UL(e){if(!e)return"";try{let t=JSON.parse(e);return Array.isArray(t)?Je(t):""}catch{return""}}async function Pr(e,t){let o=await ed(e,t);for(let n of o)await Ve(de,n.id).catch(()=>{})}async function fu(e){await jt();let t="PageType eq 'row' and ListTitle eq '"+e.replace(/'/g,"''")+"'",o=J(de,"/items?$select=Id&$filter="+encodeURIComponent(t)+"&$top=500"),n=await re(o);if(n)for(let r of n.results)await Ve(de,r.Id).catch(()=>{})}var gu=L(()=>{"use strict";Ae();St();V();Ct();ve()});function bu(){return Bs||(Bs=(async()=>{await Ut({title:Ga,fields:jL})})().catch(e=>{throw Bs=null,e}),Bs)}async function $L(){return hu||Ds||(Ds=(async()=>{let e=G+"/_api/web/siteusers?$select=Id,Title,Email,PrincipalType&$top=500",o=((await re(e).catch(()=>null))?.results||[]).filter(n=>n.PrincipalType===1&&n.Email).map(n=>({id:n.Id,title:n.Title||n.Email,email:n.Email}));return hu=o,Ds=null,o})(),Ds)}async function jv(e){let t=await $L(),o=d.meta.myUserId||0,n=e.trim().toLowerCase(),r=t.filter(a=>a.id!==o&&(!n||a.title.toLowerCase().includes(n)||a.email.toLowerCase().includes(n)));return r.sort((a,i)=>{let s=a.title.toLowerCase().startsWith(n)?0:1,l=i.title.toLowerCase().startsWith(n)?0:1;return s-l||a.title.localeCompare(i.title,"ja")}),r.slice(0,8)}async function qv(e){let t=d.meta.myUserId||await ut().catch(()=>0),o=await Hn().catch(()=>""),n=Array.from(new Set(e.recipientIds)).filter(r=>r&&r!==t);if(n.length!==0){await bu();for(let r of n)await Ne(Ga,{RecipientId:r,ActorId:t,ActorName:o,PageId:e.pageId,PageTitle:e.pageTitle.slice(0,255),CommentId:e.commentId,BlockId:e.blockId||"",Snippet:e.snippet.slice(0,255),Read:0}).catch(()=>{})}}function KL(e){return{Id:Number(e.Id),ActorId:Number(e.ActorId||0),ActorName:String(e.ActorName||""),PageId:String(e.PageId||""),PageTitle:String(e.PageTitle||""),CommentId:Number(e.CommentId||0),BlockId:String(e.BlockId||""),Snippet:String(e.Snippet||""),Read:Number(e.Read||0),ReadAt:e.ReadAt?Number(e.ReadAt):void 0,Created:e.Created?String(e.Created):void 0}}async function vu(){let e=d.meta.myUserId||await ut().catch(()=>0);if(!e)return[];await bu();let t=J(Ga,"/items?$select="+encodeURIComponent(qL)+"&$filter="+encodeURIComponent("RecipientId eq "+e)+"&$orderby=Created desc&$top=100"),n=((await re(t).catch(()=>null))?.results||[]).map(KL),r=Date.now(),a=[];for(let i of n)i.Read&&i.ReadAt&&r-i.ReadAt>zL?await Ve(Ga,i.Id).catch(()=>{}):a.push(i);return a}async function $v(){let e=d.meta.myUserId||await ut().catch(()=>0);if(!e)return 0;await bu();let t=J(Ga,"/items?$select=Id&$filter="+encodeURIComponent("RecipientId eq "+e+" and Read eq 0")+"&$top=100");return(await re(t).catch(()=>null))?.results?.length||0}async function yu(e){await je(Ga,e,{Read:1,ReadAt:Date.now()}).catch(()=>{})}var Ga,zL,jL,qL,Bs,hu,Ds,td=L(()=>{"use strict";q();Fe();St();Ae();eo();Ga="memola-inbox",zL=3*24*60*60*1e3,jL=[{name:"RecipientId",kind:9,indexed:!0},{name:"ActorId",kind:9},{name:"ActorName",kind:2},{name:"PageId",kind:2},{name:"PageTitle",kind:2},{name:"CommentId",kind:9},{name:"BlockId",kind:2},{name:"Snippet",kind:3},{name:"Read",kind:9},{name:"ReadAt",kind:9}],qL="Id,ActorId,ActorName,PageId,PageTitle,CommentId,BlockId,Snippet,Read,ReadAt,Created",Bs=null;hu=null,Ds=null});var cd={};j(cd,{ORG_COMMENTS_LIST:()=>Ar,apiAddComment:()=>id,apiDeleteComment:()=>sd,apiEditComment:()=>Eu,apiListComments:()=>rd,apiResolveThread:()=>Iu,apiToggleReaction:()=>Tu,ensureCommentsLists:()=>Ns,gcMyOrphanComments:()=>JL,getMyCommentsList:()=>Br,groupThreads:()=>nd,hydrateAuthorNames:()=>ld,invalidateComments:()=>oo,openThreadCountByBlock:()=>xu,parseReactions:()=>Rs,purgeCommentsForPage:()=>YL,remapCommentsPageId:()=>XL,selectOrphans:()=>GL});function Br(){let e=d.meta.myUserId;return e?"memola-user-"+e+"-comments":null}function Rs(e){if(!e.Reactions)return{};try{let t=JSON.parse(e.Reactions);return t&&typeof t=="object"?t:{}}catch{return{}}}async function Kv(e,t){if(await Ut({title:e,fields:VL}),t){let o=e.match(/^memola-user-(\d+)-comments$/);o&&await Ts(e,parseInt(o[1],10)).catch(()=>{})}}async function Ns(){return _s||(_s=(async()=>{d.meta.myUserId||(d.meta.myUserId=await ut().catch(()=>0)),await Kv(Ar,!1);let e=Br();e&&await Kv(e,!0)})().catch(e=>{throw _s=null,e}),_s)}function nd(e){let t=(r,a)=>(r.Created||"").localeCompare(a.Created||"")||r.Id-a.Id,o=e.filter(r=>!r.ThreadId).sort(t),n=new Map;for(let r of e){if(!r.ThreadId)continue;let a=n.get(r.ThreadId)||[];a.push(r),n.set(r.ThreadId,a)}return o.map(r=>({root:r,replies:(n.get(String(r.Id))||[]).sort(t),blockId:r.BlockId||"",resolved:(r.Resolved||0)>0}))}function xu(e){let t=new Map;for(let o of e)o.resolved||t.set(o.blockId,(t.get(o.blockId)||0)+1);return t}function GL(e,t){return e.filter(o=>!t.has(o.PageId))}function Vv(e){return{Id:Number(e.Id),PageId:String(e.PageId||""),BlockId:String(e.BlockId||""),ThreadId:String(e.ThreadId||""),Body:String(e.Body||""),Resolved:Number(e.Resolved||0),ResolvedBy:e.ResolvedBy?Number(e.ResolvedBy):void 0,ResolvedAt:e.ResolvedAt?Number(e.ResolvedAt):void 0,AnchorText:e.AnchorText?String(e.AnchorText):void 0,Scope:e.Scope==="org"?"org":"user",AuthorId:Number(e.AuthorId||0),AuthorName:e.AuthorName?String(e.AuthorName):void 0,Edited:e.Edited?Number(e.Edited):0,Deleted:e.Deleted?Number(e.Deleted):0,Reactions:e.Reactions?String(e.Reactions):void 0,Created:e.Created?String(e.Created):void 0}}async function wu(e,t){let o="PageId eq '"+t.replace(/'/g,"''")+"'",n=J(e,"/items?$select="+encodeURIComponent(WL)+"&$filter="+encodeURIComponent(o)+"&$orderby=Created&$top=500");return((await re(n).catch(()=>null))?.results||[]).map(a=>{let i=Vv(a);return i._list=e,i})}function oo(e){e?od.delete(e):od.clear()}async function rd(e){if(!e)return[];let t=od.get(e);if(t)return t;await Ns();let o=[Ar],n=Br();n&&o.push(n);let r=await Promise.all(o.map(s=>wu(s,e))),a=d.meta.myUserId||0,i=r.flat().filter(s=>s.Scope==="org"||!a||s.AuthorId===a);return od.set(e,i),i}function Wv(e){return e==="org"?Ar:Br()||Ar}function ad(e){return e._list||Wv(e.Scope)}async function ku(){let e=d.meta.myUserId||await ut().catch(()=>0),t=await Hn().catch(()=>"");return{id:e,name:t}}async function id(e){await Ns();let{id:t,name:o}=await ku(),n={PageId:e.pageId,BlockId:e.blockId||"",ThreadId:e.threadRootId||"",Body:e.body,Scope:e.scope,AuthorId:t,AuthorName:o,Resolved:0,Edited:0,Deleted:0};e.anchorText&&(n.AnchorText=e.anchorText.slice(0,255));let r=await Ne(Wv(e.scope),n);oo(e.pageId);let a=Vv(r);return e.mentions&&e.mentions.length&&await qv({recipientIds:e.mentions,pageId:e.pageId,pageTitle:D(Hs(e.pageId))?.title||"",commentId:a.Id,blockId:e.blockId||"",snippet:e.body}).catch(()=>{}),a}async function Eu(e){await je(ad(e),e.Id,{Body:e.Body,Edited:1}),oo(e.PageId)}async function sd(e){await Ve(ad(e),e.Id),oo(e.PageId)}async function Iu(e,t){let{id:o}=await ku();await je(ad(e),e.Id,{Resolved:t?1:0,ResolvedBy:t?o:0,ResolvedAt:t?Date.now():0}),oo(e.PageId)}async function Tu(e,t){let{id:o}=await ku();if(!o)return;let n=Rs(e),r=n[t]||[],a=r.indexOf(o);a>=0?r.splice(a,1):r.push(o),r.length?n[t]=r:delete n[t],await je(ad(e),e.Id,{Reactions:JSON.stringify(n)}),oo(e.PageId)}async function YL(e){await Ns().catch(()=>{});let t=[Ar,Br()].filter(Boolean);for(let o of t){let n=await wu(o,e).catch(()=>[]);for(let r of n)await Ve(o,r.Id).catch(()=>{})}oo(e)}async function XL(e){if(e.size===0)return;await Ns().catch(()=>{});let t=[Ar,Br()].filter(Boolean);for(let o of t)for(let[n,r]of e){if(n===r)continue;let a=await wu(o,n).catch(()=>[]);for(let i of a)await je(o,i.Id,{PageId:r}).catch(()=>{});oo(n),oo(r)}}async function JL(e){let t=Br();if(!t)return;let o=J(t,"/items?$select=Id,PageId&$top=500&$orderby=Id"),n=await re(o).catch(()=>null);if(!n?.results)return;let r=n.results.filter(a=>a.PageId&&!a.PageId.startsWith("row:")&&!e.has(a.PageId));for(let a of r)await Ve(t,a.Id).catch(()=>{})}async function ld(e){await Promise.all(e.map(async t=>{!t.AuthorName&&t.AuthorId&&(t.AuthorName=await Va(t.AuthorId).catch(()=>""))}))}var Ar,VL,WL,_s,od,Os=L(()=>{"use strict";q();Ae();St();eo();td();V();ve();Ar="memola-comments";VL=[{name:"PageId",kind:2,indexed:!0},{name:"BlockId",kind:2},{name:"ThreadId",kind:2},{name:"Body",kind:3},{name:"Resolved",kind:9},{name:"ResolvedBy",kind:9},{name:"ResolvedAt",kind:9},{name:"AnchorText",kind:2},{name:"Scope",kind:2},{name:"AuthorId",kind:9},{name:"AuthorName",kind:2},{name:"Edited",kind:9},{name:"Deleted",kind:9},{name:"Reactions",kind:3}],WL="Id,PageId,BlockId,ThreadId,Body,Resolved,ResolvedBy,ResolvedAt,AnchorText,Scope,AuthorId,AuthorName,Edited,Deleted,Reactions,Created",_s=null;od=new Map});var At={};j(At,{apiAddDbRow:()=>Us,apiCreateDb:()=>Fs,apiPurgeRow:()=>dd,apiRestoreRow:()=>Su,apiTrashRow:()=>QL,apiUpdateDbRow:()=>ft,duplicateDb:()=>ZL,ensureRowTrashFields:()=>Lu,getTrashedRows:()=>Mu,reconcileTrashedRows:()=>eS,stripInternalDbFields:()=>Yv});function Yv(e){return e.filter(t=>!Gv.has(t.Title)&&!Gv.has(t.InternalName))}async function Fs(e,t){let n="memola-db-"+Date.now().toString();return await Ut({title:n,fields:[{name:"Trashed",kind:9,indexed:!0},{name:"TrashedBy",kind:9,indexed:!0}]}),await Ya(e,t,n)}async function ZL(e,t){let o=t.copyRows??!t.asTemplate,n=D(e);if(!n||n.type!=="database"||!n.list)throw new Error("DB \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");let r=n.list,a=Yv(await ze(r)).filter(m=>m.Title!=="Title"&&m.InternalName!=="Title"),i=a.map(m=>({name:m.Title,kind:m.FieldTypeKind,...m.Choices?{choices:m.Choices}:{}})),s="memola-db-"+Date.now().toString();await Ut({title:s,fields:[{name:"Trashed",kind:9,indexed:!0},{name:"TrashedBy",kind:9,indexed:!0},...i]});let l=n.scope||"user",c=await Ya(n.title||"\u7121\u984C","",s,l,t.asTemplate);if(o){let m=await Te(r);for(let p of m){let u=p;if(typeof u.Trashed=="number"&&u.Trashed>0)continue;let f={Title:u.Title??""};for(let h of a){let y=u[h.InternalName]??u[h.Title];y!=null&&y!==""&&(f[h.Title]=y)}await Us(s,f).catch(()=>{})}}return c}async function Lu(e){await Ut({title:e,fields:[{name:"Trashed",kind:9,indexed:!0},{name:"TrashedBy",kind:9,indexed:!0}]}).catch(()=>{})}async function QL(e,t){let o=Date.now(),n=d.meta.myUserId||await ut().catch(()=>0);await Lu(e).catch(()=>{});let r=await Xv(e,t);if(r.length===0){let a=d.meta.pages.find(s=>s.type==="database"&&s.list===e),i="";try{let s=await Ls(e,t);i=String(s?.Title||"")}catch{}try{await Ne(de,{Title:i,ParentId:a?.id||"",PageType:"row",ListTitle:e,DbRowId:t,Body_blocks:"[]",Scope:a?.scope||"user",Trashed:o,TrashedBy:n})}catch{}}else for(let a of r)await Vc(de,a.id,n,o).catch(()=>{});await Vc(e,t,n,o).catch(()=>{})}async function Su(e,t){await Lu(e).catch(()=>{}),await Wc(e,t).catch(()=>{});let o=await Xv(e,t);for(let n of o)await Wc(de,n.id).catch(()=>{})}async function dd(e,t){await Ve(e,t).catch(()=>{}),await Pr(e,t).catch(()=>{})}async function Xv(e,t){let o="PageType eq 'row' and ListTitle eq '"+e.replace(/'/g,"''")+"' and DbRowId eq "+t,n=J(de,"/items?$select=Id&$filter="+encodeURIComponent(o)+"&$orderby=Id&$top=20");return((await re(n))?.results||[]).map(a=>({id:a.Id}))}async function eS(e,t){let o=J(de,"/items?$select=Id,DbRowId,Trashed,TrashedBy&$filter="+encodeURIComponent("PageType eq 'row' and ListTitle eq '"+e.replace(/'/g,"''")+"' and Trashed gt 0")+"&$top=500"),n=await re(o).catch(()=>null);if(n?.results)for(let r of n.results){let a=t.find(i=>i.Id===r.DbRowId);a&&(a.Trashed||await je(e,a.Id,{Trashed:r.Trashed,TrashedBy:r.TrashedBy}).catch(()=>{}))}}async function Mu(){let e=J(de,"/items?$select=Id,Title,ListTitle,DbRowId,Trashed,TrashedBy,Scope,AuthorId&$filter="+encodeURIComponent("PageType eq 'row' and Trashed gt 0")+"&$orderby=Trashed desc&$top=500"),t=await re(e).catch(()=>null);return t?t.results.filter(o=>o.ListTitle&&o.DbRowId).map(o=>({bodyId:o.Id,listTitle:o.ListTitle,dbRowId:o.DbRowId,title:o.Title||"",trashedAt:o.Trashed||0,trashedBy:o.TrashedBy||0,scope:o.Scope==="org"||o.Scope==="user"?o.Scope:"",authorId:o.AuthorId||0})):[]}async function Us(e,t){let o=t.Title,n={};for(let a of Object.keys(t))a==="Title"||a==="__metadata"||(n[a]=t[a]);let r=await Ne(e,{Title:o??""});if(Object.keys(n).length>0){await je(e,r.Id,n);for(let a of Object.keys(n))r[a]=n[a]}return r}async function ft(e,t,o){await je(e,t,o)}var Gv,qe=L(()=>{"use strict";q();Ae();V();ve();eo();St();Gv=new Set(["Trashed","TrashedBy"])});var Ja={};j(Ja,{DAILY_DATE_FIELD:()=>gt,DAILY_LIST_TITLE:()=>Le,DAILY_TAG_FIELD:()=>md,clearDailyCache:()=>Cu,convertDailyToPage:()=>Au,ensureDailyDb:()=>ud,findNoteForDate:()=>Pu,getOrCreateNoteForDate:()=>oS,isDailyList:()=>pd,isDailyTitleFormat:()=>$c,refreshDailyCacheIfActive:()=>rS,restoreToDaily:()=>nS,todayYMD:()=>yv});function Cu(){Xa=null}async function Jv(){try{return(await ze(Le)).find(o=>o.Title===gt||o.InternalName===gt)?.InternalName||gt}catch{return gt}}async function Zv(){let e=null;for(let o=0;o<3;o++){try{if((await ze(Le)).some(r=>r.Title===gt||r.InternalName===gt)){await Ir(Le,gt).catch(()=>{});return}}catch(n){e=n}try{if(await zt(Le,gt,4),(await ze(Le).catch(()=>[])).some(r=>r.Title===gt||r.InternalName===gt)){await Ir(Le,gt).catch(()=>{});return}}catch(n){e=n}await new Promise(n=>setTimeout(n,250))}let t=e instanceof Error?": "+e.message:"";throw new Error("\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8\u7528\u300C\u65E5\u4ED8\u300D\u5217\u3092\u6E96\u5099\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"+t)}function pd(e){return e===Le}async function Qv(){let t=(await ze(Le).catch(()=>[])).filter(o=>o.Title===md||o.InternalName===md||/^NoteTag\d*$/.test(o.InternalName));if(t.length===0){try{await zt(Le,md,6,["\u4ED5\u4E8B","\u500B\u4EBA","\u4F1A\u8B70","\u5BB6\u65CF","\u305D\u306E\u4ED6"])}catch{}return}if(t.length!==1){t.sort((o,n)=>o.InternalName.localeCompare(n.InternalName));for(let o=1;o<t.length;o++)await cu(Le,t[o].InternalName).catch(()=>{})}}async function ud(){return Xa||(Xa=(async()=>{let e=d.meta.pages.find(a=>a.type==="database"&&a.list===Le&&!a.trashed);if(e&&await re(J(Le))!=null)return await Zv(),await Qv(),{dbPageId:e.id,listTitle:Le,dateInternalName:await Jv()};await re(J(Le))!=null||await za(Le),await Zv(),await Qv();let o=await Jv();if(e)return{dbPageId:e.id,listTitle:Le,dateInternalName:o};let n=await Ya("\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8","",Le);await ct(n.Id,{Icon:"\u{1F4C5}",Pinned:1}).catch(()=>{});let r=D(n.Id);return r&&(r.icon="\u{1F4C5}",r.pinned=!0),go(n),{dbPageId:n.Id,listTitle:Le,dateInternalName:o}})().catch(e=>{throw Xa=null,e}),Xa)}async function Pu(e){let o=(await ud()).dateInternalName+" eq datetime'"+e+"T00:00:00'",n=J(Le,"/items?$filter="+encodeURIComponent(o)+"&$top=1"),a=(await re(n).catch(()=>null))?.results?.[0];if(!a)return null;let i=await ho(Le,a.Id).catch(()=>"");return{rowId:a.Id,title:a.Title||"",body:i}}function tS(e){return["## \u30BF\u30B9\u30AF","- [ ] ","","## \u30E1\u30E2",""].join(`
`)}async function oS(e){let t=await ud(),o=await Pu(e);if(o)return{...o,dbPageId:t.dbPageId};let n=qc(e),r=await Us(Le,{Title:n,[gt]:e}),a=tS(e);return await Oo(Le,r.Id,t.dbPageId,n,a),{rowId:r.Id,title:n,body:a,dbPageId:t.dbPageId}}async function Au(e,t,o,n=""){let r=await ho(Le,e).catch(()=>""),a=await mn(t,n);await Za(a.Id,t,r).catch(()=>{}),await ct(a.Id,{OriginDailyDate:o}).catch(()=>{});let i=D(a.Id);return i&&(i.originDailyDate=o),await Pr(Le,e).catch(()=>{}),await Ve(Le,e).catch(()=>{}),a.Id}async function nS(e){let t=D(e);if(!t?.originDailyDate)throw new Error("\u3053\u306E\u30DA\u30FC\u30B8\u306F\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8\u7531\u6765\u3067\u306F\u3042\u308A\u307E\u305B\u3093");let o=t.originDailyDate,n=await bo(e),r=await ud(),a=await Pu(o),i,s;a?(i=a.rowId,s=a.title||qc(o)):(s=qc(o),i=(await Us(Le,{Title:s,[gt]:o})).Id),await Oo(Le,i,r.dbPageId,s,n);let{apiDeletePage:l}=await Promise.resolve().then(()=>(V(),$e));return await l(e).catch(()=>{}),{rowId:i,date:o}}async function rS(){d.dbList===Le&&(d.dbItems=await Te(Le))}var Le,gt,md,Xa,Fn=L(()=>{"use strict";q();Ae();St();V();qe();Ao();ve();Le="memola-daily",gt="NoteDate",md="NoteTag",Xa=null});var Dr={};j(Dr,{isPagePublished:()=>pS,publishPage:()=>cS,publishedUrlFor:()=>lS,syncPublishedPage:()=>mS,unpublishPage:()=>dS});function oy(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{let t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}function aS(e){let t=[{id:"cbe7b0a9-3504-44dd-a3a3-0e5cacd07788",instanceId:oy(),title:"Title Region",description:"Title Region Description",audiences:[],serverProcessedContent:{htmlStrings:{},searchablePlainTexts:{},imageSources:{},links:{}},dataVersion:"1.4",properties:{title:e,imageSourceType:4,layoutType:"FullWidthImage",textAlignment:"Left",showTopicHeader:!1,showPublishDate:!1,topicHeader:"",authors:[],authorByline:[],isDecorative:!0}}];return JSON.stringify(t)}function ny(e){let t=e?Ro(e):"<p></p>",o=[{controlType:4,id:oy(),position:{controlIndex:1,sectionIndex:1,zoneIndex:1,sectionFactor:12,layoutIndex:1},addedFromPersistedData:!0,innerHTML:t},{controlType:0,pageSettingsSlice:{isDefaultDescription:!0,isDefaultThumbnail:!0}}];return JSON.stringify(o)}async function iS(e){let t=await fetch(e,{headers:{Accept:"application/json;odata=verbose"},credentials:"include"});return t.ok?t.json():null}async function ry(e,t){let o=await we(),n=await fetch(G+"/_api/sitepages/pages",{method:"POST",headers:{Accept:"application/json;odata=verbose","Content-Type":"application/json;odata=verbose","X-RequestDigest":o},credentials:"include",body:JSON.stringify({__metadata:{type:"SP.Publishing.SitePage"},PageLayoutType:"Article",Title:e})});if(!n.ok){let l=await n.text().catch(()=>"");throw new Error("SitePage \u4F5C\u6210\u5931\u6557: "+n.status+(l?" \u2014 "+l.slice(0,200):""))}let r=await n.json(),a=r.d||r,i=Number(a.Id)||0;if(!i)throw new Error("SitePage \u4F5C\u6210\u5931\u6557: ID \u53D6\u5F97\u4E0D\u53EF");await _u(i,e,t);let s=await Ru(i);return{id:i,url:s}}async function Bu(e){let t=await we();return fetch(G+"/_api/sitepages/pages("+e+")/CheckoutPage",{method:"POST",headers:{Accept:"application/json;odata=verbose","X-RequestDigest":t},credentials:"include"})}async function ey(e){let t=await we();await fetch(G+"/_api/sitepages/pages("+e+")/DiscardPage",{method:"POST",headers:{Accept:"application/json;odata=verbose","X-RequestDigest":t},credentials:"include"}).catch(()=>{})}async function ty(e,t,o){let n=await we(),r=aS(t);return fetch(G+"/_api/sitepages/pages("+e+")",{method:"POST",headers:{Accept:"application/json;odata=verbose","Content-Type":"application/json;odata=verbose","X-RequestDigest":n,"X-HTTP-Method":"MERGE","IF-MATCH":"*"},credentials:"include",body:JSON.stringify({__metadata:{type:"SP.Publishing.SitePage"},Title:t,CanvasContent1:o,LayoutWebpartsContent:r})})}async function Du(e){let t=await e.text().catch(()=>"");return e.status+(t?" \u2014 "+t.slice(0,400):"")}async function _u(e,t,o){let n=await Bu(e);if(n.status===409&&(await ey(e),n=await Bu(e)),!n.ok&&n.status!==200&&n.status!==201)throw new Error("SitePage \u30C1\u30A7\u30C3\u30AF\u30A2\u30A6\u30C8\u5931\u6557: "+await Du(n));let r=await ty(e,t,o);if(r.status===409){await ey(e);let a=await Bu(e);if(!a.ok)throw new Error("SitePage \u518D\u30C1\u30A7\u30C3\u30AF\u30A2\u30A6\u30C8\u5931\u6557: "+await Du(a));r=await ty(e,t,o)}if(!r.ok)throw new Error("SitePage \u4FDD\u5B58\u5931\u6557: "+await Du(r))}async function Ru(e){let t=await we(),o=await fetch(G+"/_api/sitepages/pages("+e+")/Publish",{method:"POST",headers:{Accept:"application/json;odata=verbose","X-RequestDigest":t},credentials:"include"});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error("SitePage \u516C\u958B\u5931\u6557: "+o.status+(s?" \u2014 "+s.slice(0,200):""))}let n=await iS(G+"/_api/sitepages/pages("+e+")"),r=n?.d||n,a=r?.AbsoluteUrl||"";if(a)return a;let i=r?.FileName||"";return i?G+"/SitePages/"+i:""}async function sS(e){let t=await we();await fetch(G+"/_api/sitepages/pages("+e+")",{method:"POST",headers:{"X-RequestDigest":t,"X-HTTP-Method":"DELETE","IF-MATCH":"*"},credentials:"include"})}function lS(e){return D(e)?.publishedUrl||""}async function cS(e,t,o){let n=D(e),r=ny(o),a,i=n?.publishedSitePageId||0;if(i){await _u(i,t,r);let s=await Ru(i)||n?.publishedUrl||"";a={id:i,url:s}}else a=await ry(t,r);return await ct(e,{Published:1,PublishedUrl:a.url,PublishedPageId:a.id,PublishedDirty:0}),n&&(n.published=!0,n.publishedUrl=a.url,n.publishedSitePageId=a.id,n.publishedDirty=!1),a.url}async function dS(e){let t=D(e),o=t?.publishedSitePageId||0;if(o)try{await sS(o)}catch{}await ct(e,{Published:0,PublishedUrl:"",PublishedPageId:0,PublishedDirty:0}).catch(()=>{}),t&&(t.published=!1,delete t.publishedUrl,delete t.publishedSitePageId,delete t.publishedDirty)}async function mS(e,t,o){let n=D(e);if(!n?.published)throw new Error("not_published");let r=ny(o),a=n.publishedSitePageId||0;if(a)await _u(a,t,r),await Ru(a);else{let i=await ry(t,r);await ct(e,{PublishedUrl:i.url,PublishedPageId:i.id}).catch(()=>{}),n.publishedUrl=i.url,n.publishedSitePageId=i.id}await ct(e,{PublishedDirty:0}).catch(()=>{}),n.publishedDirty=!1}function pS(e){return!!D(e)?.published}var _r=L(()=>{"use strict";Fe();Er();V();ln();ve()});var sy={};j(sy,{applyBlockMergeChoices:()=>gS,threeWayMergeBlocks:()=>Rr});function ay(e){return JSON.stringify(Nu(e))}function Nu(e){if(Array.isArray(e))return e.map(Nu);if(e&&typeof e=="object"){let t={};for(let o of Object.keys(e).sort())t[o]=Nu(e[o]);return t}return e}function fd(e){if(Array.isArray(e))return e.map(fd);if(e&&typeof e=="object"){let t={};for(let[o,n]of Object.entries(e))o==="id"||o==="lastBy"||o==="lastAt"||(t[o]=fd(n));return t}return e}function iy(e,t){let o=e.map(c=>c.id),n=t.map(c=>c.id),r=new Set(o),a=new Set(n),i=n.filter(c=>r.has(c)),s=o.filter(c=>a.has(c)),l=new Set;for(let c=0;c<i.length;c++)i[c]!==s[c]&&l.add(i[c]);return l}function Rr(e,t,o){let n=new Map(e.map(f=>[f.id,f])),r=new Map(t.map(f=>[f.id,f])),a=new Map(o.map(f=>[f.id,f])),i=iy(e,t),s=iy(e,o),l=i.size===0&&s.size>0,c=fS(t.map(f=>f.id),o.map(f=>f.id),l),m=[],p=0,u=[];for(let f of c){let h=n.has(f),y=r.get(f)??null,v=a.get(f)??null,g=n.get(f)??null;if(!(!y&&!v)){if(y&&!v){h?Qa(y,g)&&!i.has(f)?p++:(m.push({id:f,kind:"modify-delete",base:g,yours:y,theirs:null}),u.push(y)):u.push(y);continue}if(v&&!y){h?Qa(v,g)&&!s.has(f)?p++:(m.push({id:f,kind:"delete-modify",base:g,yours:null,theirs:v}),u.push(v)):u.push(v);continue}if(y&&v){if(!h){Qa(y,v)||m.push({id:f,kind:"add-add",base:null,yours:y,theirs:v}),u.push(y);continue}let b=!Qa(y,g),x=!Qa(v,g);if(!b&&!x)u.push(y);else if(!b&&x)u.push(v),p++;else if(b&&!x)u.push(y),p++;else if(Qa(y,v))u.push(y),p++;else{let w=g?uS(g,y,v):null;if(w){if(w.conflicts.length===0){u.push(w.merged),p++;continue}m.push(...w.conflicts),u.push(w.merged);continue}m.push({id:f,kind:"modify-modify",base:g,yours:y,theirs:v}),u.push(y)}}}}return{merged:u,conflicts:m,autoMergedCount:p}}function uS(e,t,o){if(e.kind!==t.kind||e.kind!==o.kind)return null;if(e.kind==="quote"&&t.kind==="quote"&&o.kind==="quote"){let n=Rr(e.children,t.children,o.children);return{merged:{...t,children:n.merged},conflicts:n.conflicts}}if(e.kind==="callout"&&t.kind==="callout"&&o.kind==="callout"){let n=t.emoji===o.emoji?t.emoji:t.emoji===e.emoji?o.emoji:(o.emoji===e.emoji,t.emoji),r=Rr(e.children,t.children,o.children);return{merged:{...t,emoji:n,children:r.merged},conflicts:r.conflicts}}return null}function fS(e,t,o=!1){let n=new Map;e.forEach((c,m)=>n.set(c,m));let r=new Map;t.forEach((c,m)=>r.set(c,m));let a=[],i=new Set,s=0,l=0;for(;s<e.length||l<t.length;){let c=s<e.length?e[s]:null,m=l<t.length?t[l]:null;if(c!==null&&i.has(c)){s++;continue}if(m!==null&&i.has(m)){l++;continue}if(c===null){m!==null&&(a.push(m),i.add(m),l++);continue}if(m===null){a.push(c),i.add(c),s++;continue}if(c===m){a.push(c),i.add(c),s++,l++;continue}if(!r.has(c)){a.push(c),i.add(c),s++;continue}if(!n.has(m)){a.push(m),i.add(m),l++;continue}o?(a.push(m),i.add(m),l++):(a.push(c),i.add(c),s++)}return a}function gS(e,t){let o=new Map(e.conflicts.map(r=>[r.id,r])),n=[];for(let r of e.merged){let a=o.get(r.id);if(!a){n.push(r);continue}let i=t[r.id];if(i!=="drop"){if(i==="yours"){a.yours&&n.push(a.yours);continue}if(i==="theirs"){a.theirs&&n.push(a.theirs);continue}n.push(r)}}return n}var Qa,gd=L(()=>{"use strict";Qa=(e,t)=>ay(fd(e))===ay(fd(t))});var $e={};j($e,{ORG_PAGES_LIST:()=>de,apiApplyDraftToOrigin:()=>TS,apiCreateDbPageRow:()=>Ya,apiCreatePage:()=>mn,apiCreatePageFromTemplate:()=>kS,apiDeletePage:()=>js,apiDeleteTemplate:()=>IS,apiDuplicateAsDraft:()=>xS,apiDuplicatePage:()=>ES,apiGetPages:()=>dt,apiLoadBlocksBody:()=>Dt,apiLoadContent:()=>vS,apiLoadContentMeta:()=>ju,apiLoadFileMeta:()=>mt,apiLoadRawBody:()=>bo,apiMovePage:()=>Or,apiPromoteDraftToPage:()=>LS,apiPurgePage:()=>Hr,apiRegisterPageAsTemplate:()=>wS,apiRestorePage:()=>Ks,apiSavePageBlocks:()=>ti,apiSavePageMd:()=>Za,apiSetIcon:()=>Vs,apiSetPin:()=>Ku,apiSetScope:()=>oi,apiSetTitle:()=>ni,apiTrashPage:()=>$s,appIdForCommentKey:()=>Hs,buildSourceListMap:()=>hy,clearPagesCache:()=>Hu,clearPending:()=>Un,deleteAllRowEntriesForList:()=>fu,deleteRowEntry:()=>Pr,ensurePagesList:()=>jt,filterVisiblePages:()=>gy,findOutgoingPrivateLinks:()=>yS,getMyPagesList:()=>to,getRowBody:()=>ho,getTrashedPages:()=>zu,isStructuralOpActive:()=>Uu,listForPageId:()=>nt,listTemplates:()=>Vu,markPendingCreate:()=>vy,markPendingDelete:()=>Fu,markPendingRestore:()=>yy,markRecentlyCreated:()=>jn,markStructuralOp:()=>_t,mintPageId:()=>pn,pageCommentKey:()=>qs,pageIdForListItem:()=>Cr,pageIdToItemId:()=>Pt,pagesListFor:()=>Ho,parseBlocksJson:()=>ge,resolvePageId:()=>by,scopeMismatchOnMove:()=>$u,serializeBlocks:()=>Ze,setRowBody:()=>Oo,updatePageRow:()=>ct});function to(){let e=d.meta.myUserId;return e?"memola-user-"+e+"-pages":de}function Ho(e){return e==="user"?to():de}function nt(e){let t=Bt.get(e);if(t)return t;let o=D(e);return o?Ho(o.scope==="org"?"org":"user"):de}function Hu(){ei=null}async function cy(e){await re(J(e))==null&&await za(e);let o=await dy(e),n=async(s,l)=>{if(!o.has(s))try{await zt(e,s,l),o.add(s)}catch{}};for(let[s,l]of ly)await n(s,l);let r=await dy(e),a=ly.filter(([s])=>!r.has(s)).map(([s])=>s);if(a.length>0)throw new Error(e+" \u306E\u5FC5\u9808\u5217\u304C\u4E0D\u8DB3\u3057\u3066\u3044\u307E\u3059: "+a.join(", "));for(let s of hS)await Ir(e,s).catch(()=>{});await Gc(e,zc).catch(()=>{});let i=e.match(/^memola-user-(\d+)-pages$/);if(i){let s=parseInt(i[1],10);await Ts(e,s)}}async function jt(){return ei||(ei=(async()=>{await cy(de);let e=to();e!==de&&await cy(e)})().catch(e=>{throw ei=null,e}),ei)}async function dy(e){let t=await re(J(e,"/fields?$select=Title,InternalName")),o=new Set;return t?.results.forEach(n=>{o.add(n.Title),o.add(n.InternalName)}),o}function gy(e,t){return e.filter(o=>o.PageType==="row"?!1:o.PageType==="draft"||!!o.OriginPageId?t===0?!0:o.AuthorId===t:o.Scope==="org"||t===0?!0:o.AuthorId===t)}function bS(e,t){let o={id:t,title:e.Title||"",parent:e.ParentId||"",type:e.PageType==="database"?"database":"page",icon:e.Icon||""};return e.ListTitle&&(o.list=e.ListTitle),e.Pinned&&e.Pinned>0&&(o.pinned=!0),e.Trashed&&e.Trashed>0&&(o.trashed=e.Trashed),e.Published&&e.Published>0&&(o.published=!0),e.PublishedUrl&&(o.publishedUrl=e.PublishedUrl),e.PublishedPageId&&e.PublishedPageId>0&&(o.publishedSitePageId=e.PublishedPageId),e.PublishedDirty&&e.PublishedDirty>0&&(o.publishedDirty=!0),e.OriginDailyDate&&(o.originDailyDate=e.OriginDailyDate),e.OriginPageId&&(o.originPageId=e.OriginPageId),(e.Scope==="org"||e.Scope==="user")&&(o.scope=e.Scope),e.AuthorId&&(o.authorId=e.AuthorId),e.TrashedBy&&(o.trashedBy=e.TrashedBy),e.IsTemplate&&e.IsTemplate>0&&(o.isTemplate=!0),o}async function zn(e,t){let o=Pt(e);if(!o)return null;let n=t||"Id,Title,ParentId,PageType,Icon,Pinned,Trashed,ListTitle,DbRowId,Body_blocks,Published,PublishedUrl,PublishedPageId,PublishedDirty,OriginDailyDate,OriginPageId,Scope,AuthorId,TrashedBy,IsTemplate,Modified,Editor/Title",r=/\bEditor\//.test(n)?"&$expand=Editor":"",a=J(nt(e),"/items("+o+")?$select="+encodeURIComponent(n)+r),i=await re(a);return i?{row:i,etag:i.__metadata?.etag||"",modified:i.Modified||"",editor:i.Editor?.Title||""}:null}function pn(e,t){return e===de?String(t):e+":"+t}function hy(e){let t=new Map,o=new Map;for(let n of e)for(let r of n.rows){let a=pn(n.list,r.Id);t.set(r,a),o.set(a,n.list)}return{rowToPageId:t,sourceListByPageId:o}}function by(e,t,o){let n=String(o);if(e.get(n)===t)return n;let r=t+":"+o;return e.get(r)===t?r:n}function Cr(e,t){return by(Bt,e,t)}function qs(e){return nt(e)+":"+Pt(e)}function Hs(e){if(!e||e.startsWith("row:"))return"";let t=e.lastIndexOf(":");return t<=0?e:Cr(e.slice(0,t),parseInt(e.slice(t+1),10))}function vy(e){Nr.set(e,{state:"create",at:Date.now()})}function Fu(e,t){Nr.set(e,{state:t?"delete-purge":"delete-soft",at:Date.now()})}function yy(e){Nr.set(e,{state:"restore",at:Date.now()})}function Un(e){Nr.delete(e)}function jn(e){vy(e)}function _t(e=5e3){Ou=Math.max(Ou,Date.now()+e)}function Uu(){return Date.now()<Ou}function dt(){let e=uy.then(()=>fy(),()=>fy());return uy=e.catch(()=>{}),e}async function fy(){let e=await ut().catch(()=>0);d.meta.myUserId=e||0,await jt();let t=to(),o;try{o=await Te(de,my)}catch{return d.pages}let n=[{list:de,rows:o}];if(t!==de)try{let f=await Te(t,my);n.push({list:t,rows:f})}catch{return d.pages}let r=new Map(Bt),{rowToPageId:a,sourceListByPageId:i}=hy(n);Bt.clear();for(let[f,h]of i)Bt.set(f,h);let s=n.flatMap(f=>f.rows),l=gy(s,e).map(f=>bS(f,a.get(f)??String(f.Id))),c=new Map(l.map(f=>[f.id,f])),m=Date.now();for(let[f,h]of Nr){let y=c.get(f);h.state==="create"?(y||m-h.at>=py)&&Un(f):h.state==="restore"?(y&&!y.trashed||m-h.at>=py)&&Un(f):h.state==="delete-soft"?y&&y.trashed?Un(f):y?h.absentReads=0:(h.absentReads=(h.absentReads??0)+1,h.absentReads>=2&&Un(f)):h.state==="delete-purge"&&(y?h.absentReads=0:(h.absentReads=(h.absentReads??0)+1,h.absentReads>=2&&Un(f)))}let p=[];for(let f of l){let h=Nr.get(f.id);h&&h.state==="delete-purge"||(h?.state==="delete-soft"&&!f.trashed&&(f.trashed=h.at),h?.state==="restore"&&f.trashed&&delete f.trashed,p.push(f))}let u=new Set(p.map(f=>f.id));for(let[f,h]of Nr){if(u.has(f)||h.state==="delete-purge")continue;let y=d.meta.pages.find(g=>g.id===f);if(!y)continue;let v={...y};h.state==="delete-soft"&&!v.trashed&&(v.trashed=h.at),h.state==="restore"&&delete v.trashed,p.push(v),Bt.set(f,r.get(f)||Ho(v.scope==="org"?"org":"user"))}return uu(p),Promise.resolve().then(()=>(Os(),cd)).then(f=>f.gcMyOrphanComments(new Set(d.meta.pages.map(h=>qs(h.id))))).catch(()=>{}),d.pages}function Pt(e){let t=e.lastIndexOf(":"),o=t>=0?e.substring(t+1):e;return parseInt(o,10)}function zu(){return d.meta.pages.filter(e=>e.trashed).map(e=>({id:e.id,title:e.title,trashed:e.trashed,type:e.type})).sort((e,t)=>t.trashed-e.trashed)}function ge(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Ze(e){return JSON.stringify(e)}async function vS(e){let t=await zn(e,"Body_blocks"),o=ge(t?.row.Body_blocks);return sn(o)}async function bo(e){let t=await zn(e,"Body_blocks");return Je(ge(t?.row.Body_blocks))}async function Dt(e){let o=(await zn(e,"Body_blocks"))?.row.Body_blocks;if(!o)return"[]";try{let n=JSON.parse(o);if(!Array.isArray(n))return"[]"}catch{return"[]"}return o}async function mt(e){let t=await zn(e,"Modified,Trashed");if(!t)return null;let o=t.row.Trashed;return{modified:t.modified,etag:t.etag,trashed:typeof o=="number"?o:0}}async function ju(e){let t=await zn(e,"Body_blocks,Modified");if(!t)return null;let o=t.row.Body_blocks||"",n=ge(o),r=Ze(n);return{html:sn(n),body:r,modified:t.modified,etag:t.etag}}async function ct(e,t){let o=Pt(e);if(!o)return;let n=nt(e);await je(n,o,t);try{let r=await zn(e,"Modified");r&&(d.sync.pageId===e&&(d.sync.loadedEtag=r.etag,d.sync.loadedModified=r.modified),r.etag&&tn(e).set(r.etag))}catch{}}async function mn(e,t,o="user"){await jt();let n=Ho(o),r=await Ne(n,{Title:e,ParentId:t||"",PageType:"page",Icon:"",Pinned:0,Trashed:0,Body_blocks:"[]",Scope:o,AuthorId:d.meta.myUserId}),a=pn(n,r.Id);return Bt.set(a,n),jn(a),_t(),d.meta.pages.push({id:a,title:e,parent:t||"",type:"page",icon:"",scope:o,authorId:d.meta.myUserId}),{Id:a,Title:e,ParentId:t||"",Type:"page"}}async function Ya(e,t,o,n="user",r=!1){await jt();let a=Ho(n),i=await Ne(a,{Title:e,ParentId:t||"",PageType:"database",Icon:"",Pinned:0,Trashed:0,ListTitle:o,Body_blocks:"[]",Scope:n,AuthorId:d.meta.myUserId,...r?{IsTemplate:1}:{}}),s=pn(a,i.Id);return Bt.set(s,a),jn(s),_t(),d.meta.pages.push({id:s,title:e,parent:t||"",type:"database",list:o,icon:"",scope:n,authorId:d.meta.myUserId,...r?{isTemplate:!0}:{}}),{Id:s,Title:e,ParentId:t||"",Type:"database"}}async function ti(e,t,o,n){return zs(e,t,o,n)}async function Za(e,t,o,n){let r=Xe(o);return zs(e,t,Ze(r),n)}async function zs(e,t,o,n){let r=Pt(e);if(!r)throw new Error("invalid page id");let a=D(e),i=!!a?.published,s={Title:t,Body_blocks:o};if(i&&(s.PublishedDirty=1),n){let c=nt(e);if(!(await Tr(c,r,s,n)).ok)return{ok:!1,reason:"conflict"}}else await ct(e,s);a&&(a.title=t,i&&(a.publishedDirty=!0));let l=await zn(e,"Modified");return l&&d.sync.pageId===e&&(d.sync.loadedEtag=l.etag,d.sync.loadedModified=l.modified),dn(),{ok:!0,etag:l?.etag||""}}async function qu(e){for(let t of e){let o=D(t);if(o?.type==="database"&&o.list==="memola-daily"){let{clearDailyCache:n}=await Promise.resolve().then(()=>(Fn(),Ja));n();return}}}async function js(e){_t();let t=D(e);if(t?.type==="database"&&t.list==="memola-daily")throw new Error("\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8 DB \u306F\u524A\u9664\u3067\u304D\u307E\u305B\u3093 (\u500B\u4EBA\u904B\u7528\u306B\u5FC5\u9808)");let o=hd(e);await qu(o);let n=[],r=[];for(let a of[...o].reverse()){let i=D(a),s=i?.type==="database"&&i.list?i.list:null;if(i?.published){let{unpublishPage:c}=await Promise.resolve().then(()=>(_r(),Dr));await c(a).catch(()=>{})}let l=Pt(a);try{l&&await Ve(nt(a),l),n.push(a)}catch{r.push(a);continue}if(Promise.resolve().then(()=>(Os(),cd)).then(c=>c.purgeCommentsForPage(qs(a))).catch(()=>{}),s){let{deleteAllRowEntriesForList:c}=await Promise.resolve().then(()=>(gu(),zv));await c(s).catch(()=>{}),await ja(s).catch(()=>{})}}for(let a of n)Fu(a,!0);if(No(n),r.length)throw new Error("\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F ("+r.length+" \u4EF6)\u3002\u4E00\u90E8\u306E\u30DA\u30FC\u30B8\u306F\u6B8B\u3063\u3066\u3044\u307E\u3059\u3002\u518D\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002");return n}async function Or(e,t){if(e===t)return;_t();let o=t;for(;o;){if(o===e)throw new Error("\u5FAA\u74B0\u53C2\u7167\u306B\u306A\u308A\u307E\u3059");o=D(o)?.parent||""}let n=D(e);if(!n)return;n.parent=t||"",await ct(e,{ParentId:t||""});let r=d.pages.find(a=>a.Id===e);r&&(r.ParentId=t||"")}function $u(e,t){if(!t)return null;let o=D(e),n=D(t);if(!o||!n)return null;let r=o.scope==="org"||o.scope==="user"?o.scope:"user",a=n.scope==="org"||n.scope==="user"?n.scope:"user";return r===a?null:a}async function $s(e){_t();let t=D(e);if(t?.type==="database"&&t.list==="memola-daily")throw new Error("\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8 DB \u306F\u524A\u9664\u3067\u304D\u307E\u305B\u3093 (\u500B\u4EBA\u904B\u7528\u306B\u5FC5\u9808)");let o=hd(e);await qu(o);let n=Date.now(),r=d.meta.myUserId||await ut().catch(()=>0),a=[];for(let i of o){let s=D(i),l=s?.trashed,c=s?.trashedBy;s&&(s.trashed=n,s.trashedBy=r),Fu(i,!1);try{await ct(i,{Trashed:n,TrashedBy:r})}catch{s&&(l?s.trashed=l:delete s.trashed,c?s.trashedBy=c:delete s.trashedBy),Un(i),a.push(i)}}if(a.length)throw new Error("\u30B4\u30DF\u7BB1\u3078\u306E\u79FB\u52D5\u306B\u5931\u6557\u3057\u307E\u3057\u305F ("+a.length+" \u4EF6)\u3002\u518D\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002")}async function Ks(e){let t=hd(e);await qu(t);let o=[];for(let n of t){let r=D(n),a=r?.trashed,i=r?.trashedBy;r&&(delete r.trashed,delete r.trashedBy),yy(n);try{await ct(n,{Trashed:0,TrashedBy:0})}catch{r&&(a&&(r.trashed=a),i&&(r.trashedBy=i)),Un(n),o.push(n)}}if(o.length)throw new Error("\u5FA9\u5143\u306B\u5931\u6557\u3057\u307E\u3057\u305F ("+o.length+" \u4EF6)\u3002\u518D\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002")}async function Hr(e){return _t(),js(e)}async function Ku(e,t){let o=D(e);o&&(t?o.pinned=!0:delete o.pinned,await ct(e,{Pinned:t?1:0}))}async function Vs(e,t){let o=D(e);o&&(o.icon=t),await ct(e,{Icon:t})}async function oi(e,t,o=!0){if(_t(15e3),t==="org"){let m=D(e);if(m?.type==="database"&&m.list==="memola-daily")throw new Error("\u30C7\u30A4\u30EA\u30FC\u30CE\u30FC\u30C8 DB \u306F\u7D44\u7E54\u306B\u516C\u958B\u3067\u304D\u307E\u305B\u3093 (\u500B\u4EBA\u5C02\u7528)")}let n=o?hd(e):[e],r=Ho(t);if(!n.some(m=>nt(m)!==r)){for(let p of n){let u=Pt(p);u&&await je(nt(p),u,{Scope:t}).catch(()=>{});let f=D(p);f&&(f.scope=t)}let m={};for(let p of n)m[p]=p;return{rootId:e,idMap:m}}let i=new Set(n),s={},l=["Title","PageType","Icon","Pinned","Trashed","ListTitle","DbRowId","Body_blocks","Published","PublishedUrl","PublishedPageId","PublishedDirty","OriginDailyDate","OriginPageId","IsTemplate","AuthorId"];for(let m of n){let p=nt(m),u=Pt(m);if(!u)continue;let f=await Ls(p,u).catch(()=>null);if(!f)continue;let h=f,y=h.ParentId||"",g={ParentId:i.has(y)?s[y]??"":y,Scope:t};for(let w of l)h[w]!==void 0&&h[w]!==null&&(g[w]=h[w]);let b=await Ne(r,g),x=pn(r,b.Id);s[m]=x,Bt.set(x,r),jn(x),await Ve(p,u).catch(()=>{}),Bt.delete(m)}await dt();let c={};for(let[m,p]of Object.entries(s))c[m]=Cr(r,Pt(p));return dn(),Promise.resolve().then(()=>(Os(),cd)).then(m=>m.remapCommentsPageId(new Map(Object.entries(c)))).catch(()=>{}),{rootId:c[e]??s[e]??e,idMap:c}}async function yS(e,t=new Set){let o=await Dt(e).catch(()=>null);if(!o)return[];let n;try{n=ge(o)}catch{return[]}let r=[],a=new Set,i=l=>{for(let c of l)if(c.kind==="pagelink"){let m=c.pageId;if(a.has(m)||t.has(m))continue;let p=D(m);p&&p.scope!=="org"&&(a.add(m),r.push(p.title||c.alias||m))}else(c.kind==="bold"||c.kind==="italic"||c.kind==="strike"||c.kind==="link")&&i(c.children)},s=l=>{for(let c of l){if("inline"in c&&Array.isArray(c.inline)&&i(c.inline),c.kind==="table")for(let m of c.rows)for(let p of m)i(p);if((c.kind==="quote"||c.kind==="callout")&&s(c.children),c.kind==="list")for(let m of c.items)s(m)}};return s(n),r}async function ni(e,t){let o=D(e);o&&(o.title=t,o.published&&(o.publishedDirty=!0));let n={Title:t};o?.published&&(n.PublishedDirty=1),await ct(e,n)}async function xS(e){await jt();let t=D(e);if(!t)throw new Error("\u539F\u672C\u30DA\u30FC\u30B8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");let o=await Dt(e),n="[\u4E0B\u66F8\u304D] "+(t.title||"\u7121\u984C"),r=t.scope||"user",a=Ho(r),i=await Ne(a,{Title:n,ParentId:"",PageType:"draft",Icon:"\u270F\uFE0F",Pinned:0,Trashed:0,Body_blocks:o||"[]",OriginPageId:e,OriginBaseBlocks:o||"[]",Scope:r,AuthorId:d.meta.myUserId}),s=pn(a,i.Id);return Bt.set(s,a),jn(s),_t(),d.meta.pages.push({id:s,title:n,parent:"",type:"page",icon:"\u270F\uFE0F",originPageId:e,authorId:d.meta.myUserId}),{Id:s,Title:n,ParentId:"",Type:"page",IsDraft:!0}}function Vu(){return d.meta.pages.filter(e=>e.isTemplate&&!e.trashed).sort((e,t)=>(e.title||"\u7121\u984C").localeCompare(t.title||"\u7121\u984C","ja"))}async function wS(e){await jt();let t=D(e);if(!t)throw new Error("\u30DA\u30FC\u30B8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");if(t.type==="database")throw new Error("DB \u306E\u30C6\u30F3\u30D7\u30EC\u767B\u9332\u306F\u672A\u5BFE\u5FDC\u3067\u3059");let o=await Dt(e),n=t.title||"\u7121\u984C",r=t.scope||"user",a=Ho(r),i=await Ne(a,{Title:n,ParentId:"",PageType:"page",Icon:t.icon||"",Pinned:0,Trashed:0,Body_blocks:o||"[]",Scope:r,IsTemplate:1,AuthorId:d.meta.myUserId}),s=pn(a,i.Id);return Bt.set(s,a),jn(s),_t(),d.meta.pages.push({id:s,title:n,parent:"",type:"page",icon:t.icon||"",scope:r,isTemplate:!0,authorId:d.meta.myUserId}),dn(),s}async function kS(e){await jt();let t=D(e);if(!t)throw new Error("\u30C6\u30F3\u30D7\u30EC\u30FC\u30C8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");if(t.type==="database")throw new Error("DB \u30C6\u30F3\u30D7\u30EC\u304B\u3089\u306E\u4F5C\u6210\u306F\u672A\u5BFE\u5FDC\u3067\u3059");let o=await Dt(e),n=t.title||"\u7121\u984C",r="user",a=Ho(r),i=await Ne(a,{Title:n,ParentId:"",PageType:"page",Icon:t.icon||"",Pinned:0,Trashed:0,Body_blocks:o||"[]",Scope:r,AuthorId:d.meta.myUserId}),s=pn(a,i.Id);return Bt.set(s,a),jn(s),_t(),d.meta.pages.push({id:s,title:n,parent:"",type:"page",icon:t.icon||"",scope:r,authorId:d.meta.myUserId}),dn(),{Id:s,Title:n,ParentId:"",Type:"page"}}async function ES(e){await jt();let t=D(e);if(!t)throw new Error("\u30DA\u30FC\u30B8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");if(t.type==="database")throw new Error("DB \u306F\u3053\u306E\u7D4C\u8DEF\u3067\u306F\u8907\u88FD\u3067\u304D\u307E\u305B\u3093");let o=await Dt(e),n=(t.title||"\u7121\u984C")+" (\u30B3\u30D4\u30FC)",r=t.scope||"user",a=Ho(r),i=await Ne(a,{Title:n,ParentId:t.parent||"",PageType:"page",Icon:t.icon||"",Pinned:0,Trashed:0,Body_blocks:o||"[]",Scope:r,AuthorId:d.meta.myUserId}),s=pn(a,i.Id);return Bt.set(s,a),jn(s),_t(),d.meta.pages.push({id:s,title:n,parent:t.parent||"",type:"page",icon:t.icon||"",scope:r,authorId:d.meta.myUserId}),dn(),{Id:s,Title:n,ParentId:t.parent||"",Type:"page"}}async function IS(e){let t=D(e),o=Pt(e);o&&await Ve(nt(e),o).catch(()=>{}),t?.type==="database"&&t.list&&await ja(t.list).catch(()=>{}),No([e]),dn()}async function TS(e,t){let o=D(e);if(!o)throw new Error("\u4E0B\u66F8\u304D\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");if(!o.originPageId)throw new Error("\u3053\u306E\u30DA\u30FC\u30B8\u306F\u4E0B\u66F8\u304D\u3067\u306F\u3042\u308A\u307E\u305B\u3093");let n=o.originPageId;if(!d.meta.pages.find(h=>h.id===n&&!h.trashed))throw new Error("\u539F\u672C\u30DA\u30FC\u30B8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093 (\u524A\u9664\u6E08\u307F?)");let a=o.title.replace(/^\[下書き\]\s*/,""),i=await Dt(e);if(t?.force){if(!(await zs(n,a,i||"[]")).ok)throw new Error("\u539F\u672C\u306E\u66F4\u65B0\u306B\u5931\u6557\u3057\u307E\u3057\u305F (\u7AF6\u5408)");return await js(e).catch(()=>{}),{status:"forced",originId:n}}let l=(await zn(e,"OriginBaseBlocks"))?.row.OriginBaseBlocks??"",c=await Dt(n),m=l!==""&&Ze(ge(c))===Ze(ge(l));if(!l||m)return(await zs(n,a,i||"[]")).ok?(await js(e).catch(()=>{}),{status:"applied",originId:n}):{status:"conflict",originId:n,conflicts:1};let{threeWayMergeBlocks:p}=await Promise.resolve().then(()=>(gd(),sy)),u=p(ge(l),ge(i),ge(c));return u.conflicts.length>0?{status:"conflict",originId:n,conflicts:u.conflicts.length}:(await zs(n,a,Ze(u.merged))).ok?(await js(e).catch(()=>{}),{status:"merged",originId:n,autoMerged:u.autoMergedCount}):{status:"conflict",originId:n,conflicts:1}}async function LS(e){let t=D(e);if(!t)throw new Error("\u4E0B\u66F8\u304D\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093");if(!t.originPageId)throw new Error("\u3053\u306E\u30DA\u30FC\u30B8\u306F\u4E0B\u66F8\u304D\u3067\u306F\u3042\u308A\u307E\u305B\u3093");let o=(t.title||"\u7121\u984C").replace(/^\[下書き\]\s*/,""),n=t.icon==="\u270F\uFE0F"?"":t.icon||"";return await ct(e,{Title:o,PageType:"page",OriginPageId:"",Icon:n}),t.title=o,t.originPageId=void 0,t.icon=n,dn(),e}var de,ei,ly,hS,Bt,my,Nr,py,Ou,uy,hd,V=L(()=>{"use strict";q();Ae();St();Fe();Ct();ln();Sr();eo();As();be();ve();gu();de="memola-pages";ei=null;ly=[["ParentId",2],["PageType",2],["Icon",2],["Pinned",9],["Trashed",9],["ListTitle",2],["DbRowId",9],["Body_blocks",3],["Published",9],["PublishedUrl",3],["PublishedPageId",9],["PublishedDirty",9],["OriginDailyDate",2],["OriginPageId",2],["Scope",2],["TrashedBy",9],["IsTemplate",9],["OriginBaseBlocks",3]],hS=["ListTitle","DbRowId","PageType","Scope","Trashed","TrashedBy"];Bt=new Map;my="Id,Title,ParentId,PageType,Icon,Pinned,Trashed,ListTitle,DbRowId,Published,PublishedUrl,PublishedPageId,PublishedDirty,OriginDailyDate,OriginPageId,Scope,AuthorId,TrashedBy,IsTemplate",Nr=new Map,py=5*6e4;Ou=0;uy=Promise.resolve();hd=e=>cn(d.pages,e)});function C(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Re=L(()=>{"use strict"});function wy(){return typeof BroadcastChannel>"u"?null:(ri||(ri=new BroadcastChannel(SS)),ri)}function ky(e,t,o){let n=wy();if(!n)return;let r={type:"page-saved",pageId:e,etag:t,modified:o,tabId:xy};try{n.postMessage(r)}catch{}}function Ey(){if(ri){try{ri.close()}catch{}ri=null}}function Iy(e){let t=wy();if(!t)return()=>{};let o=n=>{let r=n.data;!r||r.type!=="page-saved"||r.tabId!==xy&&e(r)};return t.addEventListener("message",o),()=>t.removeEventListener("message",o)}var SS,xy,ri,Wu=L(()=>{"use strict";Fe();SS="memola-cross-tab:"+G,xy=Math.random().toString(36).slice(2)+Date.now().toString(36),ri=null});function Gu(e){let t=e.split(`
...
/* \u2500\u2500 DB / Table view \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
#memola-dv { flex: 1; display: none; flex-direction: column; overflow-y: auto; min-width: 0; }
#memola-dv-inner {
