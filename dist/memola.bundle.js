...
`).split(`
`),o=[],n=0;for(;n<t.length;){let r=t[n];if(/^\s*$/.test(r)){n++;continue}let a=wL(r);if(a){o.push(a),n++;continue}if(/^\s*---+\s*$/.test(r)||/^\s*\*\*\*+\s*$/.test(r)){let v={id:ee(),kind:"rule"};o.push(v),n++;continue}let i=r.match(/^```(\S*)\s*$/);if(i){let v=i[1]||"",g=[];for(n++;n<t.length&&!/^```\s*$/.test(t[n]);)g.push(t[n]),n++;n<t.length&&n++;let b={id:ee(),kind:"code",lang:v,text:g.join(`
...
`)))}let x={id:ee(),kind:"list",ordered:v,items:g};o.push(x);continue}let u=r.match(/^\s*!\[([^\]]*)\]\(([^)]+)\)\s*$/);if(u){o.push({id:ee(),kind:"image",src:u[2],alt:u[1]}),n++;continue}let f=[r];for(n++;n<t.length&&!/^\s*$/.test(t[n])&&!bL(t[n]);)f.push(t[n]),n++;let h=f.join(`
`),y={id:ee(),kind:"p",inline:Is(h)};o.push(y)}return o}function bL(e){return!!(/^#{1,3}\s+/.test(e)||/^```/.test(e)||/^\s*---+\s*$/.test(e)||/^\s*\*\*\*+\s*$/.test(e)||/^\s*-\s+\[[ xX]\]/.test(e)||/^>\s?/.test(e)||/^(\s*)[-*+]\s+/.test(e)||/^(\s*)\d+\.\s+/.test(e))}function Is(e){return e?(e=e.replace(/  +\n/g,`<br>
...
`&&a++;continue}if(s==="["&&e[a+1]==="["){let l=e.indexOf("]]",a+2);if(l>=0&&l<o){let c=e.substring(a+2,l),m=c.indexOf("|"),p=m<0?c:c.substring(0,m),u=m<0?void 0:c.substring(m+1);i();let f=p.match(/^daily:(\d{4}-\d{2}-\d{2})$/);f?n.push({kind:"dailylink",date:f[1],...u!==void 0?{alias:u}:{}}):n.push({kind:"pagelink",pageId:p,...u!==void 0?{alias:u}:{}}),a=l+2;continue}}if(s==="["){let l=kv(e,"]",a+1,o);if(l>=0&&e[l+1]==="("){let c=kv(e,")",l+2,o);if(c>=0){let m=e.substring(a+1,l),p=e.substring(l+2,c);i(),n.push({kind:"link",href:p,children:Is(m)}),a=c+1;continue}}}if(s==="`"){let l=e.indexOf("`",a+1);if(l>=0&&l<o){i(),n.push({kind:"code",text:e.substring(a+1,l)}),a=l+1;continue}}if(e.startsWith("~~",a)){let l=e.indexOf("~~",a+2);if(l>=0&&l<o){i(),n.push({kind:"strike",children:Wc(e,a+2,l)}),a=l+2;continue}}if(e.startsWith("**",a)||e.startsWith("__",a)){let l=e.substr(a,2),c=e.indexOf(l,a+2);if(c>=0&&c<o){i(),n.push({kind:"bold",children:Wc(e,a+2,c)}),a=c+2;continue}}if((s==="*"||s==="_")&&e[a+1]!==s){let l=e.indexOf(s,a+1);if(l>=0&&l<o&&e[l-1]!==s){i(),n.push({kind:"italic",children:Wc(e,a+1,l)}),a=l+1;continue}}if(s==="\\"&&a+1<o&&/[!-/:-@[-`{-~]/.test(e[a+1])){r+=e[a+1],a+=2;continue}r+=s,a++}return i(),n}function vL(e){return e.replace(/([\\`*_~[\]])/g,"\\$1")}function kv(e,t,o,n){for(let r=o;r<n;r++){if(e[r]==="\\"){r++;continue}if(e[r]===t)return r}return-1}function Je(e){let t="";for(let o=0;o<e.length;o++){let n=e[o],r=yL(n).replace(/\n+$/,"");if(t){let i=e[o-1].kind==="todo"&&n.kind==="todo";t+=i?`
`:`
...
`:"")+"\u3088\u308D\u3057\u3044\u3067\u3059\u304B?";if(!confirm(r))return;_(!0,"\u5B8C\u5168\u524A\u9664\u4E2D...");let a=0,i=0,s=new Set;for(let c of o)try{c.kind==="row"&&c.rowListTitle&&c.rowDbRowId?(await sd(c.rowListTitle,c.rowDbRowId),s.add(c.rowListTitle)):await Hr(c.bodyId),a++}catch{i++}try{await dt()}catch{}for(let c of s)await Ab(c);_(!1),oe(),Op();let l=`${a} \u4EF6\u524A\u9664\u3057\u307E\u3057\u305F`;i>0&&(l+=` (\u5931\u6557 ${i} \u4EF6)`),n.length>0&&(l+=` / \u4ED6\u306E\u30E6\u30FC\u30B6\u306E ${n.length} \u4EF6\u306F\u6B8B\u3063\u3066\u3044\u307E\u3059`),k(l)}async function Op(){let e=E("trash-list");e.innerHTML='<div class="memola-trash-empty">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let t=await X1();if(e.innerHTML="",t.length===0){e.innerHTML='<div class="memola-trash-empty">\u30B4\u30DF\u7BB1\u306F\u7A7A\u3067\u3059</div>';return}let o=Array.from(new Set(t.map(a=>a.trashedBy).filter(a=>a>0))),n=new Map;await Promise.all(o.map(async a=>{let i=await qa(a);i&&n.set(a,i)}));let r=d.meta.myUserId||0;t.forEach(a=>{let i=document.createElement("div");i.className="memola-trash-row";let s=new Date(a.trashedAt).toLocaleString("ja-JP"),l=a.trashedBy===r?"\u3042\u306A\u305F":n.get(a.trashedBy)||"\u4E0D\u660E",c=a.trashedBy===r,m=a.kind==="database"?"\u{1F5C3} DB":a.kind==="row"?"\u{1F4CB} \u884C":"\u{1F4C4} \u30DA\u30FC\u30B8",p=a.kind==="row"&&a.rowParentDbTitle?` \xB7 ${C(a.rowParentDbTitle)} \u5185`:"";i.innerHTML='<div class="memola-trash-info"><div class="memola-trash-title">'+C(a.title||"(\u7121\u984C)")+'</div><div class="memola-trash-meta">'+m+p+" \xB7 <b>"+C(l)+"</b> \u304C "+s+' \u306B\u524A\u9664</div></div><button class="memola-trash-btn memola-trash-restore" title="\u5FA9\u5143">\u21BA</button><button class="memola-trash-btn memola-trash-purge" '+(c?'title="\u5B8C\u5168\u524A\u9664"':'title="\u4ED6\u306E\u30E6\u30FC\u30B6\u304C\u524A\u9664\u3057\u305F\u9805\u76EE\u306F\u5B8C\u5168\u524A\u9664\u3067\u304D\u307E\u305B\u3093" disabled')+">\u{1F5D1}</button>",i.querySelector(".memola-trash-restore").addEventListener("click",async()=>{try{_(!0,"\u5FA9\u5143\u4E2D..."),a.kind==="row"&&a.rowListTitle&&a.rowDbRowId?(await wu(a.rowListTitle,a.rowDbRowId),await Ab(a.rowListTitle)):await js(a.bodyId),await dt(),oe(),await Op(),k("\u5FA9\u5143\u3057\u307E\u3057\u305F")}catch(u){k("\u5FA9\u5143\u5931\u6557: "+u.message,"err")}finally{_(!1)}}),c&&i.querySelector(".memola-trash-purge").addEventListener("click",async()=>{if(confirm("\u5B8C\u5168\u306B\u524A\u9664\u3057\u307E\u3059\u3002\u5143\u306B\u623B\u305B\u307E\u305B\u3093\u3002"))try{_(!0,"\u524A\u9664\u4E2D..."),a.kind==="row"&&a.rowListTitle&&a.rowDbRowId?(await sd(a.rowListTitle,a.rowDbRowId),await Ab(a.rowListTitle)):await Hr(a.bodyId);try{await dt()}catch{}oe(),await Op(),k("\u5B8C\u5168\u306B\u524A\u9664\u3057\u307E\u3057\u305F")}catch(u){k("\u524A\u9664\u5931\u6557: "+u.message,"err")}finally{_(!1)}}),e.appendChild(i)})}var Db=L(()=>{"use strict";q();me();W();qe();Zt();_e();le();Re();we()});function Z1(e){J1||(J1=!0,Gh([{id:"new-page",label:"\u65B0\u3057\u3044\u30DA\u30FC\u30B8",icon:"\uFF0B",key:"\u2318N",run:()=>{Io("")}},{id:"new-db",label:"\u65B0\u3057\u3044DB",icon:"\u{1F5C2}",key:"\u2318\u21E7N",run:()=>{e.doNewDb("")}},{id:"ai-ask",label:"AI\u306B\u8CEA\u554F",icon:"\u2726",key:"\u2318\u21E7A",run:()=>{ic()}},{id:"toc",label:"\u76EE\u6B21\u30D1\u30CD\u30EB\u3092\u5207\u66FF",icon:"\u2630",key:"\u2318\u21E7L",run:()=>{Yl()}},{id:"props",label:"\u30D7\u30ED\u30D1\u30C6\u30A3\u30D1\u30CD\u30EB\u3092\u5207\u66FF",icon:"\u25A4",key:"\u2318\u21E7R",run:()=>{Xl()}},{id:"focus",label:"\u96C6\u4E2D\u30E2\u30FC\u30C9\u5207\u66FF",icon:"\u26F6",key:"\u2318\u21E7F",run:()=>{Rp()}},{id:"trash",label:"\u30B4\u30DF\u7BB1\u3092\u958B\u304F",icon:"\u{1F5D1}",key:"",run:()=>{Hp()}},{id:"settings",label:"\u8A2D\u5B9A",icon:"\u2699",key:"",run:()=>{document.getElementById("memola-settings-md")?.classList.add("on")}}]))}var J1,Q1=L(()=>{"use strict";ac();Pn();hr();ji();qi();Pb();Db();J1=!1});var tT={};j(tT,{clearCurrentWorkspace:()=>Rb,ensureWorkspaceSelected:()=>jD,getCurrentWorkspaceName:()=>Up,loadWorkspaces:()=>wa,saveWorkspaces:()=>Fp,setCurrentWorkspace:()=>zp,showWorkspaceMenu:()=>ka,switchWorkspace:()=>_b,validateWorkspaceUrl:()=>eT});function wa(){let e=Dc.get();if(!e)return[];try{return JSON.parse(e)}catch{return[]}}function Fp(e){Dc.set(JSON.stringify(e))}function Up(){let e=yr.get();return e?wa().some(o=>o.name===e)?e:(yr.clear(),xr.clear(),""):""}function zp(e,t){yr.set(e),xr.set(t)}function Rb(){yr.clear(),xr.clear()}async function eT(e){let t=e.trim().replace(/\/$/,"");if(!/^https:\/\//.test(t))return"URL \u306F https:// \u3067\u59CB\u3081\u3066\u304F\u3060\u3055\u3044";if(!/\/sites\/[^/]+/.test(t)&&!/^https:\/\/[^/]+$/.test(t))return"SharePoint \u30B5\u30A4\u30C8 URL \u306E\u5F62\u5F0F\u3067\u306F\u3042\u308A\u307E\u305B\u3093 (\u4F8B: https://contoso.sharepoint.com/sites/team)";try{let o=await fetch(t+"/_api/web?$select=Title",{headers:{Accept:"application/json;odata=verbose"},credentials:"include"});return o.status===404?"\u30B5\u30A4\u30C8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093 (404)":o.status===403?"\u30B5\u30A4\u30C8\u3078\u306E\u30A2\u30AF\u30BB\u30B9\u6A29\u304C\u3042\u308A\u307E\u305B\u3093 (403)":o.status===401?"SharePoint \u306B\u30ED\u30B0\u30A4\u30F3\u3057\u3066\u3044\u306A\u3044\u3001\u307E\u305F\u306F\u8A8D\u8A3C\u304C\u5207\u308C\u3066\u3044\u307E\u3059 (401)":o.ok?null:"\u30B5\u30A4\u30C8\u78BA\u8A8D\u306B\u5931\u6557\u3057\u307E\u3057\u305F ("+o.status+")"}catch(o){return"\u63A5\u7D9A\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F: "+o.message}}async function _b(e){_(!0,"\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u3092\u5207\u66FF\u4E2D\u2026");try{zp(e.name,e.url),Xp(e.url),gv(),tu(),Bu(),Eu(),nE(),Jp();let{renderTree:t}=await Promise.resolve().then(()=>(_e(),ko)),{showView:o}=await Promise.resolve().then(()=>(K(),se)),{stopWatching:n}=await Promise.resolve().then(()=>(Qr(),tp));n(),o("empty"),t(),await dt(),t();let r=document.getElementById("memola-ws-name");r&&(r.textContent=e.name),Promise.resolve().then(()=>(Go(),ir)).then(c=>c.refreshDraftsBadge?.());let a=await Promise.resolve().then(()=>(K(),se)),i=a.loadLastOpenedPage(),l=(i?d.pages.find(c=>c.Id===i&&!c.IsDraft):null)||d.pages.find(c=>!c.IsDraft)||null;l&&await a.doSelect(l.Id),k("\u300C"+e.name+"\u300D \u306B\u5207\u308A\u66FF\u3048\u307E\u3057\u305F")}catch(t){k("\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u5207\u66FF\u5931\u6557: "+t.message,"err")}finally{_(!1)}}async function jD(){let e=wa();if(e.length===0)return;let t=yr.get();if(t&&e.some(n=>n.name===t))return;Rb();let o=e.find(n=>n.url.replace(/\/$/,"")===G);if(o){zp(o.name,o.url);return}k("\u73FE\u5728\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u304C\u524A\u9664\u3055\u308C\u3066\u3044\u307E\u3059 \u2014 \u4E00\u89A7\u304B\u3089\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044","err")}function ka(e){document.getElementById("memola-ws-menu")?.remove();let t=wa(),o=Up(),n=document.createElement("div");if(n.id="memola-ws-menu",n.className="memola-ws-menu",t.length===0){let c=document.createElement("div");c.className="memola-ws-empty",c.textContent="\u307E\u3060\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u305B\u3093",n.appendChild(c)}else t.forEach(c=>{let m=document.createElement("div");m.className="memola-ws-item"+(c.name===o?" on":""),m.innerHTML='<div class="memola-ws-item-body"><div class="memola-ws-item-name">'+C(c.name)+'</div><div class="memola-ws-item-url">'+C(c.url)+'</div></div><button class="memola-ws-item-rn" title="\u540D\u79F0\u5909\u66F4">'+$.edit+'</button><button class="memola-ws-item-rm" title="\u4E00\u89A7\u304B\u3089\u524A\u9664">'+$.trash+"</button>",m.querySelector(".memola-ws-item-body")?.addEventListener("click",()=>{s(),c.name!==o&&_b(c)}),m.querySelector(".memola-ws-item-rn")?.addEventListener("click",p=>{p.stopPropagation();let u=prompt("\u65B0\u3057\u3044\u540D\u79F0:",c.name);if(u==null)return;let f=u.trim();if(!f||f===c.name)return;let h=wa();if(h.some(v=>v.name===f)){k("\u540C\u3058\u540D\u79F0\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u304C\u65E2\u306B\u3042\u308A\u307E\u3059","err");return}let y=h.map(v=>v.name===c.name?{...v,name:f}:v);if(Fp(y),o===c.name){zp(f,c.url);let v=document.getElementById("memola-ws-name");v&&(v.textContent=f)}k("\u540D\u79F0\u3092\u5909\u66F4\u3057\u307E\u3057\u305F"),s(),ka(e)}),m.querySelector(".memola-ws-item-rm")?.addEventListener("click",async p=>{if(p.stopPropagation(),!confirm("\u300C"+c.name+"\u300D \u3092\u4E00\u89A7\u304B\u3089\u524A\u9664\u3057\u307E\u3059\u3002SharePoint \u4E0A\u306E\u30C7\u30FC\u30BF\u306B\u306F\u5F71\u97FF\u3057\u307E\u305B\u3093\u3002\u3088\u308D\u3057\u3044\u3067\u3059\u304B?"))return;let u=wa().filter(f=>f.name!==c.name);if(Fp(u),k("\u524A\u9664\u3057\u307E\u3057\u305F"),o===c.name){if(u.length>0){s();let h=document.getElementById("memola-ws-name");h&&(h.textContent=u[0].name),await _b(u[0]),ka(e);return}Rb();let f=document.getElementById("memola-ws-name");f&&(f.textContent="Memola")}s(),ka(e)}),n.appendChild(m)});let r=document.createElement("div");r.className="memola-ws-sep",n.appendChild(r);let a=document.createElement("div");a.className="memola-ws-add",a.textContent="+ \u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u3092\u8FFD\u52A0",a.addEventListener("click",async()=>{let c=prompt("\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u540D (\u4F8B: \u55B6\u696D\u30C1\u30FC\u30E0):");if(!c||!c.trim())return;let m=prompt("SharePoint \u30B5\u30A4\u30C8 URL (\u4F8B: https://contoso.sharepoint.com/sites/sales):");if(!m||!m.trim())return;let p=c.trim(),u=m.trim().replace(/\/$/,""),f=wa();if(f.some(y=>y.name===p)){k("\u540C\u3058\u540D\u79F0\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u304C\u65E2\u306B\u3042\u308A\u307E\u3059","err");return}_(!0,"URL \u3092\u78BA\u8A8D\u4E2D\u2026");let h=null;try{h=await eT(u)}finally{_(!1)}if(h){k("\u8FFD\u52A0\u3067\u304D\u307E\u305B\u3093: "+h,"err");return}f.push({name:p,url:u}),Fp(f),k("\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u300C"+p+"\u300D \u3092\u8FFD\u52A0\u3057\u307E\u3057\u305F"),s(),ka(e)}),n.appendChild(a);let i=e.getBoundingClientRect();n.style.position="fixed",n.style.top=i.bottom+4+"px",n.style.left=i.left+"px",document.getElementById("memola-overlay")?.appendChild(n),setTimeout(()=>{document.addEventListener("click",l)},0);function s(){n.remove(),document.removeEventListener("click",l)}function l(c){!n.contains(c.target)&&c.target!==e&&s()}}var Nb=L(()=>{"use strict";q();Fe();kr();le();Er();De();W();Re();Nn();Ah();be()});function nT(){if(oT)return;oT=!0,E("outline-btn").addEventListener("click",Yl),document.getElementById("memola-outline-x")?.addEventListener("click",()=>{Promise.resolve().then(()=>(ji(),Lh)).then(t=>t.setOutlineOpen(!1))}),Th(),pa(),E("props-btn").addEventListener("click",Xl),document.getElementById("memola-props-x")?.addEventListener("click",()=>{Promise.resolve().then(()=>(qi(),Sh)).then(t=>t.setPropertiesOpen(!1))}),ua(),E("trash-btn").addEventListener("click",Hp),E("trash-close").addEventListener("click",Bb),E("trash-md").addEventListener("click",t=>{t.target===E("trash-md")&&Bb()});let e=Up();e&&(E("ws-name").textContent=e),E("ws-btn").addEventListener("click",t=>{t.stopPropagation(),ka(E("ws-btn"))})}var oT,rT=L(()=>{"use strict";me();ji();qi();Db();Nb();oT=!1});var mT={};j(mT,{attachInbox:()=>Hb,closeInbox:()=>qp,navigateToMention:()=>Fb,openInbox:()=>sT,pollMentions:()=>dT,refreshInboxBadge:()=>Ub});function Hb(){if(aT)return;aT=!0,document.getElementById("memola-inbox-btn")?.addEventListener("click",sT),document.getElementById("memola-inbox-close")?.addEventListener("click",qp),document.getElementById("memola-inbox-readall")?.addEventListener("click",()=>void $D());let e=document.getElementById(Ob);e?.addEventListener("click",t=>{t.target===e&&qp()}),dT()}function qp(){document.getElementById(Ob)?.classList.remove("on")}async function sT(){let e=document.getElementById(Ob);e&&e.classList.add("on"),await lT()}async function lT(){let e=document.getElementById("memola-inbox-list");if(e){e.innerHTML='<div class="memola-inbox-empty">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';try{ss=await pu()}catch{ss=[]}if(ss.length===0){e.innerHTML='<div class="memola-inbox-empty">\u30E1\u30F3\u30B7\u30E7\u30F3\u306F\u3042\u308A\u307E\u305B\u3093\u3002</div>';return}e.innerHTML=ss.map(t=>{let o=t.Created?Dn(Date.parse(t.Created)):"";return'<div class="memola-inbox-item'+(t.Read?" read":"")+'" data-id="'+t.Id+'">'+(t.Read?"":'<span class="memola-inbox-dot"></span>')+'<div class="memola-inbox-main"><div class="memola-inbox-line1"><span class="memola-inbox-actor">'+C(t.ActorName||"\u8AB0\u304B")+'</span> \u304C\u3042\u306A\u305F\u3092\u30E1\u30F3\u30B7\u30E7\u30F3<span class="memola-inbox-time">'+C(o)+'</span></div><div class="memola-inbox-page">'+C(t.PageTitle||"(\u30DA\u30FC\u30B8)")+'</div><div class="memola-inbox-snippet">'+C(t.Snippet||"")+"</div></div></div>"}).join(""),e.querySelectorAll(".memola-inbox-item").forEach(t=>{t.addEventListener("click",()=>void qD(Number(t.dataset.id)))})}}async function qD(e){let t=ss.find(o=>o.Id===e);t&&(qp(),await Fb(t))}async function Fb(e){await uu(e.Id).catch(()=>{}),jp.add(e.Id),Ub();try{let{doSelect:t}=await Promise.resolve().then(()=>(K(),se)),{appIdForCommentKey:o}=await Promise.resolve().then(()=>(W(),$e)),n=o(e.PageId)||e.PageId;await t(n),(await Promise.resolve().then(()=>(jo(),wn))).focusComment(e.PageId,e.CommentId)}catch{}}async function $D(){await Promise.all(ss.filter(e=>!e.Read).map(e=>uu(e.Id))),await lT(),Ub()}function cT(e){let t=E("inbox-btn")?.querySelector(".memola-inbox-badge-count");t&&(t.textContent=e>0?"("+e+")":"")}async function Ub(){try{cT(await Nv())}catch{}}async function dT(){let e;try{e=await pu()}catch{return}let t=e.filter(o=>!o.Read);if(cT(t.length),!iT){t.forEach(o=>jp.add(o.Id)),iT=!0;return}for(let o of t)jp.has(o.Id)||(jp.add(o.Id),VD(o))}function KD(){let e=document.getElementById("memola-mention-toasts");return e||(e=document.createElement("div"),e.id="memola-mention-toasts",(document.getElementById("memola-overlay")||document.body).appendChild(e)),e}function VD(e){let t=document.createElement("div");t.className="memola-mention-toast",t.innerHTML='<div class="memola-mention-toast-hd">\u{1F4AC} '+C(e.ActorName||"\u8AB0\u304B")+' \u304C\u3042\u306A\u305F\u3092\u30E1\u30F3\u30B7\u30E7\u30F3</div><div class="memola-mention-toast-page">'+C(e.PageTitle||"(\u30DA\u30FC\u30B8)")+"</div>"+(e.Snippet?'<div class="memola-mention-toast-snippet">'+C(e.Snippet)+"</div>":"")+'<button class="memola-mention-toast-x" title="\u9589\u3058\u308B">\xD7</button>';let o=()=>{t.classList.remove("on"),setTimeout(()=>t.remove(),200)};t.querySelector(".memola-mention-toast-x")?.addEventListener("click",n=>{n.stopPropagation(),o()}),t.addEventListener("click",()=>{o(),Fb(e)}),KD().appendChild(t),requestAnimationFrame(()=>t.classList.add("on")),setTimeout(o,9e3)}var Ob,aT,ss,jp,iT,zb=L(()=>{"use strict";me();Re();Lo();Zc();Ob="memola-inbox-md",aT=!1;ss=[];jp=new Set,iT=!1});function uT(){try{return JSON.stringify(d.meta.pages)}catch{return String(d.meta.pages.length)}}async function fT(e={}){if(!jb&&!(Date.now()-pT<WD)&&!re.isBusy()&&!_u()&&!re.isDirty()){jb=!0;try{try{let t=uT();if(await dt(),uT()!==t){let{renderTree:o}=await Promise.resolve().then(()=>(_e(),ko));o()}}catch{}if(!d.currentId)return;if(!e.periodic&&d.currentType==="database"&&!d.currentRow){let t=d.pages.find(o=>o.Id===d.currentId);if(t)await(await Promise.resolve().then(()=>(K(),se))).doSelectDb(d.currentId,t);else{d.currentId=null;let{showView:o}=await Promise.resolve().then(()=>(K(),se));o("empty")}}}finally{pT=Date.now(),jb=!1}}}function gT(){let e=document.body;e.dataset.memolaTabRefocusWired!=="1"&&(e.dataset.memolaTabRefocusWired="1",document.addEventListener("visibilitychange",()=>{document.hidden||fT()}))}function GD(){let e=Bn.get(),t=e?parseInt(e,10):3e4;return isFinite(t)?t:3e4}function qb(){gc&&(clearTimeout(gc),gc=null);let e=GD();if(e<=0){gc=setTimeout(qb,6e4);return}gc=setTimeout(()=>{(async()=>{document.hidden||(await fT({periodic:!0}),Promise.resolve().then(()=>(jo(),wn)).then(t=>t.pollComments()).catch(()=>{}),Promise.resolve().then(()=>(zb(),mT)).then(t=>t.pollMentions()).catch(()=>{}))})().finally(qb)},e)}function hT(){let e=document.body;e.dataset.memolaTreeSyncWired!=="1"&&(e.dataset.memolaTreeSyncWired="1",qb())}var WD,pT,jb,gc,bT=L(()=>{"use strict";q();W();ht();be();WD=3e3,pT=0,jb=!1;gc=null});function xT(){vT||(vT=!0,re.subscribe(YD))}function YD(e){let t=yT;switch(yT=e.kind,e.kind){case"unloaded":d.currentRow||(d.dirty=!1,d.saving=!1),d.sync.loadedEtag=null,d.sync.loadedModified=null;return;case"idle":d.dirty=!1,d.saving=!1,d.sync.loadedEtag=e.base.etag,d.sync.loadedModified=e.base.modified,Ye("\u4FDD\u5B58\u6E08\u307F"),(t==="saving"||t==="merging")&&(fy(e.base.pageId,e.base.etag,e.base.modified),Jo(e.base.pageId).set(e.base.etag),Promise.resolve().then(()=>(_e(),ko)).then(o=>o.renderTree()));return;case"dirty":d.dirty=!0,d.saving=!1,d.sync.loadedEtag=e.base.etag,d.sync.loadedModified=e.base.modified,Ye("\u672A\u4FDD\u5B58");return;case"saving":d.dirty=!0,d.saving=!0,d.sync.loadedEtag=e.base.etag,d.sync.loadedModified=e.base.modified,Ye("\u4FDD\u5B58\u4E2D...");return;case"conflict":d.dirty=!0,d.saving=!1,d.sync.loadedEtag=e.conflict.base.etag,Ye("\u7AF6\u5408");return;case"merging":d.dirty=!0,d.saving=!1,d.sync.loadedEtag=e.conflict.base.etag,Ye("\u7AF6\u5408");return}}var vT,yT,wT=L(()=>{"use strict";q();le();ht();zu();be();vT=!1,yT=null});function ET(){kT||(kT=!0,re.subscribe(JD))}function JD(e){if(e.kind!=="conflict"){$b.close();return}ZD(e.conflict.pageId,e.conflict.ours.title)}function ZD(e,t){if($b.isOpen())return;let n=d.pages.find(r=>r.Id===e)?.Title||t||"\u7121\u984C";$b.render('<div class="memola-conflict-box"><div class="memola-conflict-title">\u26A0 \u4ED6\u306E\u30E6\u30FC\u30B6\u30FC\u304C\u3053\u306E\u30DA\u30FC\u30B8\u3092\u66F4\u65B0\u3057\u307E\u3057\u305F</div><div class="memola-conflict-page">\u300C'+C(n)+'\u300D</div><div class="memola-conflict-msg">\u540C\u3058\u30DA\u30FC\u30B8\u3092\u5225\u306E\u4EBA\u304C\u5148\u306B\u7DE8\u96C6\u3057\u3066\u3044\u307E\u3057\u305F\u3002<br>\u3069\u3046\u6271\u3044\u307E\u3059\u304B\uFF1F</div><div class="memola-conflict-btns"><button class="memola-btn p" data-choice="merge" title="\u81EA\u5206\u306E\u7DE8\u96C6\u3068\u76F8\u624B\u306E\u7DE8\u96C6\u3092 3-way \u30DE\u30FC\u30B8\u3067\u7D50\u5408\u3057\u307E\u3059\u3002\u540C\u3058\u7B87\u6240\u304C\u4E21\u65B9\u5909\u66F4\u3055\u308C\u3066\u305F\u5834\u5408\u306E\u307F\u9078\u629E\u3092\u6C42\u3081\u3089\u308C\u307E\u3059">\u{1F500} \u7D71\u5408\u3059\u308B <span class="memola-conflict-sub">(\u63A8\u5968 \u2014 \u53CC\u65B9\u306E\u7DE8\u96C6\u3092\u878D\u5408)</span></button><button class="memola-btn s" data-choice="overwrite" title="\u81EA\u5206\u306E\u7DE8\u96C6\u5185\u5BB9\u3067 SP \u306E\u7248\u3092\u4E0A\u66F8\u304D\u3057\u307E\u3059 (\u76F8\u624B\u306E\u5909\u66F4\u306F SP \u306E\u5C65\u6B74\u304B\u3089\u5FA9\u5143\u3067\u304D\u307E\u3059)">\u4E0A\u66F8\u304D\u3067\u4FDD\u5B58 <span class="memola-conflict-sub">(\u76F8\u624B\u306E\u7DE8\u96C6\u306F\u7834\u68C4)</span></button><button class="memola-btn s" data-choice="reload" title="\u81EA\u5206\u306E\u7DE8\u96C6\u5185\u5BB9\u3092\u4E0B\u66F8\u304D\u306B\u4FDD\u5B58\u3057\u3066\u304B\u3089\u3001\u76F8\u624B\u306E\u6700\u65B0\u7248\u3092\u8AAD\u307F\u8FBC\u307F\u307E\u3059">\u76F8\u624B\u306E\u7248\u3092\u8868\u793A <span class="memola-conflict-sub">(\u81EA\u5206\u306E\u7DE8\u96C6\u306F\u4E0B\u66F8\u304D\u306B\u4FDD\u5B58)</span></button><button class="memola-btn ghost" data-choice="cancel" title="\u30C0\u30A4\u30A2\u30ED\u30B0\u3092\u9589\u3058\u307E\u3059\u3002\u3042\u3068\u3067\u5224\u65AD\u3067\u304D\u307E\u3059">\u3053\u306E\u307E\u307E\u306B\u3059\u308B</button></div><div class="memola-conflict-foot">\u5931\u3063\u305F\u5909\u66F4\u306F<b>\u300C\u{1F4DD} \u4E0B\u66F8\u304D\u300D</b> \u307E\u305F\u306F <b>SP \u306E\u30D0\u30FC\u30B8\u30E7\u30F3\u5C65\u6B74</b> \u304B\u3089\u5FA9\u5143\u53EF\u80FD\u3067\u3059\u3002</div></div>',r=>{r.querySelectorAll("button[data-choice]").forEach(a=>{a.addEventListener("click",()=>{let i=a.dataset.choice;QD(i,e,n)})})})}async function QD(e,t,o){switch(e){case"merge":re.startMerge();return;case"overwrite":{let n=await re.forceOverwrite();n.ok?(k("\u81EA\u5206\u306E\u7248\u3067\u4E0A\u66F8\u304D\u3057\u307E\u3057\u305F"),Promise.resolve().then(()=>(Go(),ir)).then(r=>r.refreshDraftsBadge?.())):!n.ok&&n.reason==="error"&&k("\u4E0A\u66F8\u304D\u5931\u6557: "+(n.error?.message||""),"err");return}case"reload":{let n=re.state();if(n.kind!=="conflict")return;let r=n.conflict;try{let{saveDraft:i}=await Promise.resolve().then(()=>(Wl(),hh));i({pageId:r.pageId,pageTitle:o,title:r.ours.title,body:r.ours.body,reason:"conflict-discarded",baseBody:r.base.body,baseEtag:r.base.etag})}catch{}re.acceptTheirs(),k("\u81EA\u5206\u306E\u7DE8\u96C6\u306F\u4E0B\u66F8\u304D\u306B\u4FDD\u5B58\u3057\u307E\u3057\u305F\uFF08\u30B5\u30A4\u30C9\u30D0\u30FC\u300C\u{1F4DD} \u4E0B\u66F8\u304D\u300D\u304B\u3089\u5FA9\u5143\u53EF\uFF09"),Promise.resolve().then(()=>(Go(),ir)).then(i=>i.refreshDraftsBadge?.());let{doSelect:a}=await Promise.resolve().then(()=>(K(),se));await a(t);return}case"cancel":re.cancelConflict();return}}var XD,$b,kT,IT=L(()=>{"use strict";q();Re();ht();le();ar();XD="memola-conflict-md",$b=In({id:XD,className:"memola-conflict-md",onEscape:()=>re.cancelConflict(),onBackdropClick:()=>re.cancelConflict()}),kT=!1});function ST(){TT||(TT=!0,re.subscribe(t_))}function t_(e){if(e.kind!=="merging"){LT.close();return}o_(e)}function o_(e){let t=e.hunks.length,o=t-e.resolved.size,n=t===0?'<span class="memola-merge-ok">\u2713 \u7AF6\u5408\u306A\u3057 \u2014 \u81EA\u52D5\u30DE\u30FC\u30B8\u5B8C\u4E86</span>':o===0?'<span class="memola-merge-ok">\u2713 '+t+" \u4EF6\u3059\u3079\u3066\u89E3\u6C7A\u6E08\u307F</span>":'<span class="memola-merge-warn">\u26A0 \u6B8B\u308A '+o+" / "+t+" \u4EF6\u306E\u7AF6\u5408</span>",r=o>0?'<div class="memola-merge-preview-pending">\u26A0 \u6B8B\u308A '+o+" \u4EF6\u306E\u7AF6\u5408\u3092\u5DE6\u30DA\u30A4\u30F3\u3067\u89E3\u6C7A\u3059\u308B\u3068\u3001\u3053\u3053\u306B\u6700\u7D42\u7684\u306A\u5185\u5BB9\u304C\u8868\u793A\u3055\u308C\u307E\u3059\u3002</div>":Co(re.computeMergedBody()),a=n_(e),i=`
  ...
  `;LT.render(i,s=>{s.querySelectorAll("[data-conflict-id]").forEach(l=>{l.addEventListener("click",()=>{let c=parseInt(l.dataset.conflictId||"0",10),m=l.dataset.choice;re.setMergeChoice(c,m)})}),s.querySelectorAll("[data-merge-act]").forEach(l=>{l.addEventListener("click",()=>{let c=l.dataset.mergeAct;c==="cancel"?re.cancelMerge():c==="apply"&&r_()})})})}function n_(e){return e.hunks.length===0?'<div class="memola-merge-empty">\u{1F389} \u81EA\u52D5\u30DE\u30FC\u30B8\u3067\u5168\u3066\u89E3\u6C7A\u3057\u307E\u3057\u305F\u3002\u53F3\u306E\u5185\u5BB9\u3092\u78BA\u8A8D\u3057\u3066\u4FDD\u5B58\u3057\u3066\u304F\u3060\u3055\u3044\u3002</div>':e.hunks.map(t=>{let o=e.resolved.get(t.id),n=o?"memola-merge-conflict resolved":"memola-merge-conflict",r=t.yours.length===0?"<i>(\u524A\u9664)</i>":C(t.yours.join(`
